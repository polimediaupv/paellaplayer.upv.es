...
(function () {
      ...
      value: function setVisible(visible, animate) {
        ...
        if (visible && animate) {
          ...
          $(this.domElement).animate({
            ...
            return $(_this60.domElement).hide();
          });
        } else if (!visible && !animate) {
          $(this.domElement).hide();
        }
  ...
  var VideoContainerBase = /*#__PURE__*/function (_paella$DomNode7) {
    ...
    function VideoContainerBase(id) {
      ...
      _this61 = _possibleConstructorReturn(this, _getPrototypeOf(VideoContainerBase).call(this, 'div', id, style));
      _this61._trimming = {
        enabled: false,
        start: 0,
        end: 0
      };
      _this61.timeupdateEventTimer = null;
      _this61.timeupdateInterval = 250;
      _this61.masterVideoData = null;
      _this61.slaveVideoData = null;
      _this61.currentMasterVideoData = null;
      _this61.currentSlaveVideoData = null;
      _this61._force = false;
      _this61._playOnClickEnabled = true;
      _this61._seekDisabled = false;
      _this61._seekType = paella.SeekType.FULL;
      _this61._seekTimeLimit = 0;
      _this61._attenuationEnabled = false;
      $(_this61.domElement).click(function (evt) {
        if (_this61.firstClick && base.userAgent.browser.IsMobileVersion) return;
        if (_this61.firstClick && !_this61._playOnClickEnabled) return;
        paella.player.videoContainer.paused().then(function (paused) {
          _this61.firstClick = true;
      ...
      _this61.domElement.addEventListener("touchstart", function (event) {
    ...
    _createClass(VideoContainerBase, [{
      ...
      value: function triggerTimeupdate() {
        ...
        this.paused().then(function (p) {
          paused = p;
          return _this62.duration();
        }).then(function (d) {
          duration = d;
          return _this62.currentTime();
        }).then(function (currentTime) {
          if (!paused || _this62._force) {
            _this62._seekTimeLimit = currentTime > _this62._seekTimeLimit ? currentTime : _this62._seekTimeLimit;
            _this62._force = false;
            paella.events.trigger(paella.events.timeupdate, {
              videoContainer: _this62,
      ...
      value: function seekTo(newPositionPercent) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          paella.player.videoContainer.currentTime().then(function (t) {
            ...
            if (_this64._seekTimeLimit > 0 && _this64._seekType == paella.SeekType.BACKWARDS_ONLY) {
              time = _this64._seekTimeLimit;
            }
            ...
            _this64.setCurrentPercent(newPositionPercent).then(function (timeData) {
              _this64._force = true;
      ...
      value: function seekToTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            if (_this65._seekTimeLimit && _this65._seekType == paella.SeekType.BACKWARDS_ONLY) {
              currentTime = _this65._seekTimeLimit;
            }
            ...
            _this65.setCurrentTime(time).then(function (timeData) {
              _this65._force = true;
      ...
      value: function trimStart() {
        ...
        return new Promise(function (resolve) {
          resolve(_this66._trimming.start);
        });
      }
    }, {
      key: "trimEnd",
      ...
      value: function trimEnabled() {
        ...
        return new Promise(function (resolve) {
          resolve(_this68._trimming.enabled);
        });
      }
    }, {
      key: "trimming",
      ...
      value: function setTrimming(start, end) {
        ...
        return new Promise(function (resolve) {
          ...
          _this70.currentTime(true).then(function (c) {
            currentTime = c;
            return _this70.duration();
          }).then(function (duration) {
            _this70._trimming.start = Math.floor(start);
            _this70._trimming.end = Math.floor(end);

            if (_this70._trimming.enabled) {
              if (currentTime < _this70._trimming.start) {
                _this70.setCurrentTime(0);
              }

              if (currentTime > _this70._trimming.end) {
                _this70.setCurrentTime(duration);
              }
            ...
            paella.events.trigger(paella.events.setTrim, {
              trimEnabled: _this70._trimming.enabled,
              trimStart: _this70._trimming.start,
              trimEnd: _this70._trimming.end
            });
            resolve();
          });
        });
      ...
      value: function setCurrentPercent(percent) {
        ...
        var duration = 0;
        return new Promise(function (resolve) {
          _this71.duration().then(function (d) {
            duration = d;
            return _this71.trimming();
            ...
            return _this71.setCurrentTime(position);
    ...
    _createClass(StreamProvider, [{
      ...
      value: function startVideoSync(syncProviderPlayer) {
        ...
        var sync = function sync() {
          _this73._syncProviderPlayer.currentTime().then(function (t) {
          ...
          _this73._syncTimer = setTimeout(function () {
            return sync();
          }, 1000);
        };
      ...
      value: function callPlayerFunction(fnName) {
        ...
        return new Promise(function (resolve, reject) {
          Promise.all(promises).then(function () {
            if (fnName == 'play' && !_this74._firstPlay) {
              _this74._firstPlay = true;

              if (_this74._startTime) {
                _this74.players.forEach(function (p) {
                  return p.setCurrentTime(_this74._startTime);
                });
              }
            }
  ...
  var VideoContainer = /*#__PURE__*/function (_paella$VideoContaine) {
    ...
    function VideoContainer(id) {
      ...
      _this75 = _possibleConstructorReturn(this, _getPrototypeOf(VideoContainer).call(this, id));
      _this75._streamProvider = new paella.StreamProvider();
      _this75._ready = false;
      _this75._videoWrappers = [];
      _this75._container = new paella.DomNode('div', 'playerContainer_videoContainer_container', {
        position: 'relative',
        display: 'block',
        marginLeft: 'auto',
        marginRight: 'auto',
      ...
      _this75._container.domElement.setAttribute('role', 'main');

      _this75.addNode(_this75._container);

      _this75.overlayContainer = new paella.VideoOverlay(_this75.domElement);

      _this75.container.addNode(_this75.overlayContainer);

      _this75.setProfileFrameStrategy(paella.ProfileFrameStrategy.Factory());

      _this75.setVideoQualityStrategy(paella.VideoQualityStrategy.Factory());

      _this75._audioTag = paella.player.config.player.defaultAudioTag || paella.dictionary.currentLanguage();
      _this75._audioPlayer = null;
      _this75._volume = 1;
      return _this75;
    ...
    _createClass(VideoContainer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this76.streamProvider.startTime = _this76._startTime;

          _this76.streamProvider.callPlayerFunction('play').then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "play", _this76).call(_this76);
      ...
      value: function pause() {
        ...
        return new Promise(function (resolve, reject) {
          _this77.streamProvider.callPlayerFunction('pause').then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "pause", _this77).call(_this77);
      ...
      value: function setCurrentTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          _this78.trimming().then(function (trimmingData) {
            ...
            return _this78.streamProvider.callPlayerFunction('setCurrentTime', time);
          }).then(function () {
            return _this78.duration(false);
          }).then(function (duration) {
            resolve({
              time: time,
              duration: duration
      ...
      value: function currentTime() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this79.masterVideo().currentTime();
          }).then(function (time) {
            if (trimmingData.enabled) {
      ...
      value: function setVolume(params) {
        ...
        if (_typeof(params) == 'object') {
          ...
          return new Promise(function (resolve, reject) {
            _this80._audioPlayer.setVolume(params).then(function () {
      ...
      value: function duration() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this81.masterVideo().duration();
          }).then(function (duration) {
            if (trimmingData.enabled) {
      ...
      value: function getAudioTags() {
        ...
        return new Promise(function (resolve) {
          var lang = [];
          var p = _this82.streamProvider.players;
      ...
      value: function setAudioTag(lang) {
        ...
        return new Promise(function (resolve) {
          ...
          _this83.streamProvider.players.forEach(function (player) {
            if (!firstAudioPlayer) {
          ...
          if (!audioSet && _this83.streamProvider.mainVideoPlayer) {
            _this83._audioPlayer = _this83.streamProvider.mainVideoPlayer;
          } else if (!audioSet && firstAudioPlayer) {
            _this83._audioPlayer = firstAudioPlayer;
          }

          Promise.all(promises).then(function () {
            return _this83._audioPlayer.setVolume(_this83._volume);
          }).then(function () {
            _this83._audioTag = _this83._audioPlayer.stream.audioTag;
            paella.events.trigger(paella.events.audioTagChanged);

            _this83.streamProvider.startVideoSync(_this83.audioPlayer);
      ...
      value: function setStreamData(videoData) {
        ...
        return new Promise(function (resolve, reject) {
          _this84.streamProvider.init(videoData);
          ...
          videoData.forEach(function (video) {
            ...
            if (video.audioTag == _this84._audioTag) {
              streamDataAudioTag = _this84._audioTag;
            }
          });

          if (streamDataAudioTag != _this84._audioTag && streamDataAudioTag != null) {
            _this84._audioTag = streamDataAudioTag;
          }

          _this84.streamProvider.videoPlayers.forEach(function (player, index) {
            addVideoWrapper.apply(_this84, ['videoPlayerWrapper_' + index, player]);
            player.setAutoplay(_this84.autoplay());
          });

          _this84.streamProvider.loadVideos()["catch"](function (err) {
            reject(err);
          }).then(function () {
            return _this84.setAudioTag(_this84.audioTag);
          }).then(function () {
            var endedTimer = null;

            var eventBindingObject = _this84.masterVideo().video || _this84.masterVideo().audio;

            $(eventBindingObject).bind('timeupdate', function (evt) {
              _this84.trimming().then(function (trimmingData) {
                ...
                paella.events.trigger(paella.events.timeupdate, {
                  videoContainer: _this84,
                  currentTime: current,
                  duration: duration
                });

                if (current >= duration) {
                  _this84.streamProvider.callPlayerFunction('pause');
...
(function () {
  var PluginManager = /*#__PURE__*/function () {
    ...
    function PluginManager() {
      ...
      paella.events.bind(paella.events.loadPlugins, function (event) {
        _this85.loadPlugins("paella.DeferredLoadPlugin");
      });
      var timer = new base.Timer(function () {
        if (paella.player && paella.player.controls && _this85.doResize) paella.player.controls.onresize();
      }, 1000);
      timer.repeat = true;
    }
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          if (plugin.type == "eventDriven" && isEnabled) {
            ...
            _this86.eventDrivenPlugins.push(plugin);
  ...
  var PopUpContainer = /*#__PURE__*/function (_paella$DomNode8) {
    ...
    function PopUpContainer(id, className) {
      ...
      var style = {};
      _this87 = _possibleConstructorReturn(this, _getPrototypeOf(PopUpContainer).call(this, 'div', id, style));
      _this87.containers = null;
      _this87.currentContainerId = -1;
      _this87.domElement.className = className;
      _this87.containers = {};
      return _this87;
    }
  ...
  var ButtonPlugin = /*#__PURE__*/function (_paella$UIPlugin) {
    ...
    function ButtonPlugin() {
      ...
      _this88 = _possibleConstructorReturn(this, _getPrototypeOf(ButtonPlugin).call(this));
      _this88.subclass = '';
      _this88.container = null;
      _this88.containerManager = null;
      return _this88;
    }
  ...
  var EventDrivenPlugin = /*#__PURE__*/function (_paella$EarlyLoadPlug) {
    ...
    function EventDrivenPlugin() {
      ...
      _this89 = _possibleConstructorReturn(this, _getPrototypeOf(EventDrivenPlugin).call(this));

      var events = _this89.getEvents();

      for (var i = 0; i < events.length; ++i) {
        var event = events[i];

        if (event == paella.events.loadStarted) {
          _this89.onEvent(paella.events.loadStarted);
        }
      }
    ...
    if (!paella.WebGLCanvas) {
      var WebGLCanvas = /*#__PURE__*/function (_bg$app$WindowControl) {
        ...
        function WebGLCanvas(stream) {
          ...
          _this90 = _possibleConstructorReturn(this, _getPrototypeOf(WebGLCanvas).call(this));
          _this90._stream = stream;
          return _this90;
        }
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.loadVideoTexture().then(function (texture) {
              _this92._texture = texture;

              _this92.buildVideoSurface(_this92._root, texture);
            });
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_base$AsyncLoaderCall) {
    ...
    function SearchCallback(caption, text) {
      ...
      _this93 = _possibleConstructorReturn(this, _getPrototypeOf(SearchCallback).call(this));
      _this93.name = "captionSearchCallback";
      _this93.caption = caption;
      _this93.text = text;
      return _this93;
    }
      ...
      value: function search(txt, next) {
        ...
        if (this._index == undefined) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            _this95._index.search(txt).forEach(function (s) {
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_base$AsyncLoaderCall2) {
    ...
    function SearchCallback(plugin, text) {
      ...
      _this96 = _possibleConstructorReturn(this, _getPrototypeOf(SearchCallback).call(this));
      _this96.name = "searchCallback";
      _this96.plugin = plugin;
      _this96.text = text;
      return _this96;
    }
...
(function () {
  var TimeControl = /*#__PURE__*/function (_paella$DomNode9) {
    ...
    function TimeControl(id) {
      ...
      _this99 = _possibleConstructorReturn(this, _getPrototypeOf(TimeControl).call(this, 'div', id, {
        left: "0%"
      }));
      _this99.domElement.className = 'timeControlOld';
      _this99.domElement.className = 'timeControl'; //this.domElement.innerText = "0:00:00";

      var thisClass = _assertThisInitialized(_this99);
  ...
  var PlaybackBar = /*#__PURE__*/function (_paella$DomNode10) {
    ...
    function PlaybackBar(id) {
      ...
      var style = {};
      _this100 = _possibleConstructorReturn(this, _getPrototypeOf(PlaybackBar).call(this, 'div', id, style));
      _this100.playbackFullId = '';
      _this100.updatePlayBar = true;
      _this100.timeControlId = '';
      _this100._images = null;
      _this100._keys = null;
      _this100._prev = null;
      _this100._next = null;
      _this100._videoLength = null;
      _this100._lastSrc = null;
      _this100._aspectRatio = 1.777777778;
      _this100._hasSlides = null;
      _this100._imgNode = null;
      _this100._canvas = null;
      _this100.domElement.className = "playbackBar";

      _this100.domElement.setAttribute("alt", ""); //this.domElement.setAttribute("title", "Timeline Slider");


      _this100.domElement.setAttribute("aria-label", "Timeline Slider");

      _this100.domElement.setAttribute("role", "slider");

      _this100.domElement.setAttribute("aria-valuemin", "0");

      _this100.domElement.setAttribute("aria-valuemax", "100");

      _this100.domElement.setAttribute("aria-valuenow", "0");

      _this100.domElement.setAttribute("tabindex", "1100");

      $(_this100.domElement).keyup(function (event) {
        var currentTime = 0;
        var duration = 0;
        paella.player.videoContainer.currentTime().then(function (t) {
          currentTime = t;
      ...
      _this100.playbackFullId = id + "_full";
      _this100.timeControlId = id + "_timeControl";
      var playbackFull = new paella.DomNode('div', _this100.playbackFullId, {
        width: '0%'
      });
      playbackFull.domElement.className = "playbackBarFull";

      _this100.addNode(playbackFull);

      _this100.addNode(new paella.TimeControl(_this100.timeControlId));

      var thisClass = _assertThisInitialized(_this100);

      paella.events.bind(paella.events.timeupdate, function (event, params) {
        thisClass.onTimeUpdate(params);
      });
      $(_this100.domElement).bind('mousedown', function (event) {
      ...
      if (!base.userAgent.browser.IsMobileVersion) {
        $(_this100.domElement).bind('mousemove', function (event) {
        ...
        $(_this100.domElement).bind("mouseout", function (event) {
          thisClass.mouseOut(event);
        });
      }

      $(_this100.domElement).bind('mouseup', function (event) {
    ...
    _createClass(PlaybackBar, [{
      ...
      value: function drawTimeMarks() {
        ...
        paella.player.videoContainer.trimming().then(function (t) {
          ...
          var duration = trimming.enabled ? trimming.end - trimming.start : _this101._videoLength;
          var parent = $("#playerContainer_controls_playback_playbackBar");

          _this101.clearCanvas();

          if (_this101._keys && paella.player.config.player.slidesMarks.enabled) {
            _this101._keys.forEach(function (l) {
              var timeInstant = parseInt(l) - trimming.start;

              if (timeInstant > 0) {
                var aux = timeInstant * parent.width() / _this101._videoLength; // conversion to canvas


                _this101.drawTimeMark(aux);
              }
            });
          }
        });
        ...
        return new Promise(function (resolve) {
          paella.player.videoContainer.duration().then(function (duration) {
            ...
            if (!n || Object.keys(n).length === 0) {
              _this102._hasSlides = false;
              return;
            } else {
              _this102._hasSlides = true;
            }

            _this102._images = n; // COPY TO LOCAL

            _this102._videoLength = duration; // SORT KEYS FOR SEARCH CLOSEST

            _this102._keys = Object.keys(_this102._images);
            _this102._keys = _this102._keys.sort(function (a, b) {
  ...
  var PlaybackControl = /*#__PURE__*/function (_paella$DomNode11) {
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          ...
          if (isEnabled) {
            $(plugin.button).show();
            paella.pluginManager.setupPlugin(plugin);
            var id = 'buttonPlugin' + _this104.buttonPlugins.length;

            if (plugin.getButtonType() == paella.ButtonPlugin.type.popUpButton) {
              parent = _this104.popUpPluginContainer.domElement;
              var popUpContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_container');

              _this104.popUpPluginContainer.registerContainer(plugin.getName(), popUpContent, button, plugin);
            } else if (plugin.getButtonType() == paella.ButtonPlugin.type.timeLineButton) {
              parent = _this104.timeLinePluginContainer.domElement;
              var timeLineContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_timeline');

              _this104.timeLinePluginContainer.registerContainer(plugin.getName(), timeLineContent, button, plugin);
            }
          } else {
            _this104.pluginsContainer.domElement.removeChild(plugin.button);
          }
        });
      }
    }]);
    ...
    function PlaybackControl(id) {
      ...
      var style = {};
      _this103 = _possibleConstructorReturn(this, _getPrototypeOf(PlaybackControl).call(this, 'div', id, style));
      _this103.playbackBarId = '';
      _this103.pluginsContainer = null;
      _this103._popUpPluginContainer = null;
      _this103._timeLinePluginContainer = null;
      _this103.playbackPluginsWidth = 0;
      _this103.popupPluginsWidth = 0;
      _this103.minPlaybackBarSize = 120;
      _this103.playbackBarInstance = null;
      _this103.buttonPlugins = [];
      _this103.domElement.className = 'playbackControls';
      _this103.playbackBarId = id + '_playbackBar';

      var thisClass = _assertThisInitialized(_this103);

      _this103.pluginsContainer = new paella.DomNode('div', id + '_playbackBarPlugins');
      _this103.pluginsContainer.domElement.className = 'playbackBarPlugins';

      _this103.pluginsContainer.domElement.setAttribute("role", "toolbar");

      _this103.addNode(_this103.pluginsContainer);

      _this103.addNode(new paella.PlaybackBar(_this103.playbackBarId));

      paella.pluginManager.setTarget('button', _assertThisInitialized(_this103));
      $(window).mousemove(function (evt) {
        if (_this103._expandedPlugin && $(window).height() - evt.clientY > 50) {
          _this103._expandedPlugin.contract();

          _this103._expandPlugin = null;
        }
      });
      return _this103;
    }
  ...
  var ControlsContainer = /*#__PURE__*/function (_paella$DomNode12) {
    ...
    function ControlsContainer(id) {
      ...
      _this105 = _possibleConstructorReturn(this, _getPrototypeOf(ControlsContainer).call(this, 'div', id));
      _this105.playbackControlId = '';
      _this105.editControlId = '';
      _this105.isEnabled = true;
      _this105.autohideTimer = null;
      _this105.hideControlsTimeMillis = 3000;
      _this105.playbackControlInstance = null;
      _this105.videoOverlayButtons = null;
      _this105.buttonPlugins = [];
      _this105._hidden = false;
      _this105._over = false;
      _this105.viewControlId = id + '_view';
      _this105.playbackControlId = id + '_playback';
      _this105.editControlId = id + '_editor';

      _this105.addNode(new paella.PlaybackControl(_this105.playbackControlId));
      ...
      $(_this105.domElement).bind("mousemove", function (event) {
        thisClass._over = true;
      });
      $(_this105.domElement).bind("mouseout", function (event) {
      ...
      _this105.videoOverlayButtons = new paella.DomNode('div', id + '_videoOverlayButtonPlugins');
      _this105.videoOverlayButtons.domElement.className = 'videoOverlayButtonPlugins';

      _this105.videoOverlayButtons.domElement.setAttribute("role", "toolbar");

      _this105.addNode(_this105.videoOverlayButtons);

      paella.pluginManager.setTarget('videoOverlayButton', _assertThisInitialized(_this105));
      return _this105;
    }
...
(function () {
  var LoaderContainer = /*#__PURE__*/function (_paella$DomNode13) {
    ...
    function LoaderContainer(id) {
      ...
      _this108 = _possibleConstructorReturn(this, _getPrototypeOf(LoaderContainer).call(this, 'div', id, {
        position: 'fixed',
      ...
      _this108.timer = null;
      _this108.loader = null;
      _this108.loaderPosition = 0;
      _this108.loader = _this108.addNode(new paella.DomNode('i', '', {
        width: "100px",
        height: "100px",
        color: "black",
        display: "block",
      ...
      _this108.loader.domElement.className = "icon-spinner";
      paella.events.bind(paella.events.loadComplete, function (event, params) {
        _this108.loadComplete(params);
      });
      _this108.timer = new base.Timer(function (timer) {
        //thisClass.loaderPosition -= 128;
        //thisClass.loader.domElement.style.backgroundPosition = thisClass.loaderPosition + 'px';
        _this108.loader.domElement.style.transform = "rotate(".concat(_this108.loaderPosition, "deg");
        _this108.loaderPosition += 45;
      }, 250);
      _this108.timer.repeat = true;
      return _this108;
    }
    ...
    _createClass(KeyManager, [{
      ...
      value: function addPlugin(plugin) {
        ...
        if (plugin.checkEnabled(function (e) {
          _this109._pluginList.push(plugin);
  ...
  var InitDelegate = /*#__PURE__*/function () {
    ...
    _createClass(InitDelegate, [{
      ...
      value: function loadDictionary() {
        ...
        return new Promise(function (resolve) {
          base.ajax.get({
            url: _this110.initParams.dictionaryUrl + "_" + base.dictionary.currentLanguage() + '.json'
      ...
      value: function loadConfig() {
        ...
        var loadAccessControl = function loadAccessControl(data) {
          ...
          _this111.initParams.accessControl = new AccessControlClass();
        };

        if (this.initParams.config) {
          return new Promise(function (resolve) {
            loadAccessControl(_this111.initParams.config);
            resolve(_this111.initParams.config);
          });
        } else if (this.initParams.loadConfig) {
          return new Promise(function (resolve, reject) {
            _this111.initParams.loadConfig(_this111.initParams.configUrl).then(function (data) {
          ...
          return new Promise(function (resolve, reject) {
            var configUrl = _this111.initParams.configUrl;
            var params = {};
...
(function () {
  var PaellaPlayer = /*#__PURE__*/function (_paella$PlayerBase) {
    ...
    function PaellaPlayer(playerId) {
      ...
      _this112 = _possibleConstructorReturn(this, _getPrototypeOf(PaellaPlayer).call(this, playerId));
      _this112.player = null;
      _this112.videoIdentifier = '';
      _this112.loader = null; // Video data:

      _this112.videoData = null; // if initialization ok

      if (_this112.playerId == playerId) {
        _this112.loadPaellaPlayer();

        var thisClass = _assertThisInitialized(_this112);
      }
    ...
    _createClass(PaellaPlayer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this113.videoContainer.play().then(function () {
            if (!_this113.controls) {
              _this113.showPlaybackBar();

              paella.events.trigger(paella.events.controlBarLoaded);

              _this113.controls.onresize();
            }
      ...
      value: function playing() {
        ...
        return new Promise(function (resolve) {
          _this114.paused().then(function (p) {
            resolve(!p);
          });
        });
      }
  ...
  var LazyThumbnailContainer = /*#__PURE__*/function (_paella$DomNode14) {
    ...
    function LazyThumbnailContainer(src) {
      ...
      _this115 = _possibleConstructorReturn(this, _getPrototypeOf(LazyThumbnailContainer).call(this, 'img', 'lazyLoadThumbnailContainer', {}));
      _this115.domElement.src = src;
      _this115.domElement.alt = "";
      _this115.container = LazyThumbnailContainer.GetIconElement();

      if (!paella.player.videoContainer) {
        document.body.appendChild(_this115.container);
      }
  ...
  var PaellaPlayerLazy = /*#__PURE__*/function (_PaellaPlayer) {
    ...
    function PaellaPlayerLazy(playerId, initDelegate) {
      ...
      _this116 = _possibleConstructorReturn(this, _getPrototypeOf(PaellaPlayerLazy).call(this, playerId, initDelegate));
      g_lazyLoadInstance = _assertThisInitialized(_this116);
      return _this116;
    }
        ...
        if (this.videoIdentifier) {
          ...
          loader.loadVideo(function () {
            if (!loader.metadata.preview) {
              paella.load(_this117.playerId, paella.loaderFunctionParams);
              g_lazyLoadInstance = null; // Lazy load is disabled when the video has no preview
            } else {
              _this117.lazyLoadContainer = new LazyThumbnailContainer(loader.metadata.preview);
              document.body.appendChild(_this117.lazyLoadContainer.domElement);

              _this117.lazyLoadContainer.onClick(function () {
                _this117.lazyLoadContainer.destroyElements();

                _this117.lazyLoadContainer = null;
                _this117._onPlayClosure && _this117._onPlayClosure();
              });
...
(function () {
  ...
  var DefaultVideoLoader = /*#__PURE__*/function (_paella$VideoLoader) {
    ...
    function DefaultVideoLoader(data) {
      ...
      _this118 = _possibleConstructorReturn(this, _getPrototypeOf(DefaultVideoLoader).call(this, data));
      _this118._url = null;
      ...
      if (_typeof(data) == "object") {
        ...
        try {
          _this118._data = JSON.parse(data);
        } catch (e) {
          _this118._url = data;
        }
      }
      ...
      value: function loadVideo(onSuccess) {
        ...
        if (this._data) {
          ...
          loadVideoDelegate().then(function (data) {
            ...
            _this119.loadVideoData(_this119._data, onSuccess);
          });
        } else if (url) {
          var This = this;
          base.ajax.get({
          ...
          if (window.WebKitPlaybackTargetAvailabilityEvent) {
            video.addEventListener('webkitplaybacktargetavailabilitychanged', function (event) {
              switch (event.availability) {
                case "available":
                  _this120._visible = true;
                  break;

                case "not-available":
                  _this120._visible = false;
                  break;
              }

              _this120.updateClassName();
            });
          }
        }
      }, {
          ...
          return new Promise(function (resolve) {
            if (_this121._frames.length < 1) {
              ...
              paella.player.videoContainer.duration().then(function (d) {
                ...
                if (!_this121._frames.some(function (f1, i, array) {
                  if (i + 1 == array.length) {
                    return;
                  }

                  var f0 = i == 0 ? f1 : _this121._frames[i - 1];
                  var f2 = _this121._frames[i + 1];
                  ...
                  var t0 = _this121._frames[_this121._frames.length - 2].time;
                  var t1 = _this121._frames[_this121._frames.length - 1].time;
                  resolve({
      ...
      _createClass(AudioSelector, [{
        ...
        value: function buildContent(domElement) {
          ...
          this._tags.forEach(function (tag) {
            domElement.appendChild(_this123.getItemButton(tag));
          });
        }
      }, {
        key: "getItemButton",
      ...
      _createClass(BreaksPlayerPlugin, [{
        ...
        value: function onEvent(eventType, params) {
          ...
          paella.player.videoContainer.currentTime(true).then(function (currentTime) {
            ...
            var diff = Math.abs(currentTime - _this125.lastTime);

            _this125.checkBreaks(currentTime, diff >= 1 ? paella.events.seekToTime : paella.events.timeUpdate);

            _this125.lastTime = currentTime;
          });
        }
      }, {
        key: "checkBreaks",
        value: function checkBreaks(currentTime, eventType) {
          ...
          if (this.breaks.some(function (breakItem) {
            if (breakItem.s <= currentTime && breakItem.e >= currentTime) {
              if (eventType == paella.events.timeUpdate && !_this126.status) {
                _this126.skipTo(breakItem.e);
              }
        ...
        value: function updateCaptions(time) {
          ...
          if (this.captions) {
            paella.player.videoContainer.trimming().then(function (trimming) {
              ...
              if (caption) {
                $(_this128.container).show();
                _this128.innerContainer.innerText = caption.content;

                _this128.moveCaptionsOverlay("auto");
              } else {
                _this128.innerContainer.innerText = "";

                _this128.hideContent();
              }
            });
          }
        }
...
(function () {
  function buildChromaVideoCanvas(stream, canvas) {
    var ChromaVideoCanvas = /*#__PURE__*/function (_bg$app$WindowControl2) {
      ...
      function ChromaVideoCanvas(stream) {
        ...
        _this129 = _possibleConstructorReturn(this, _getPrototypeOf(ChromaVideoCanvas).call(this));
        _this129.stream = stream;
        _this129._chroma = bg.Color.White();
        _this129._crop = new bg.Vector4(0.3, 0.01, 0.3, 0.01);
        _this129._transform = bg.Matrix4.Identity().translate(0.6, -0.04, 0);
        _this129._bias = 0.01;
        return _this129;
      }
  ...
  var ChromaVideo = /*#__PURE__*/function (_paella$VideoElementB4) {
    ...
    function ChromaVideo(id, stream, left, top, width, height, streamName) {
      ...
      _this132 = _possibleConstructorReturn(this, _getPrototypeOf(ChromaVideo).call(this, id, stream, 'canvas', left, top, width, height));
      _this132._posterFrame = null;
      _this132._currentQuality = null;
      _this132._autoplay = false;
      _this132._streamName = null;
      _this132._streamName = streamName || 'chroma';

      var This = _assertThisInitialized(_this132);

      if (_this132._stream.sources[_this132._streamName]) {
        _this132._stream.sources[_this132._streamName].sort(function (a, b) {
          return a.res.h - b.res.h;
        });
      }
    ...
    _createClass(ChromaVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this133.video) {
            ...
            $(_this133.video).bind('canplay', function () {
              _this133._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this134._deferredAction(function () {
            resolve({
              duration: This.video.duration,
              currentTime: This.video.currentTime,
              volume: This.video.volume,
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this135._loadDeps().then(function () {
            var sources = _this135._stream.sources[_this135._streamName];

            if (_this135._currentQuality === null && _this135._videoQualityStrategy) {
              _this135._currentQuality = _this135._videoQualityStrategy.getQualityIndex(sources);
            }

            var stream = _this135._currentQuality < sources.length ? sources[_this135._currentQuality] : null;
            _this135.video = null;
            _this135.domElement.parentNode.style.backgroundColor = "transparent";

            if (stream) {
              _this135.canvasController = null;
              buildChromaVideoCanvas(stream, _this135.domElement).then(function (canvasController) {
                _this135.canvasController = canvasController;
                _this135.video = canvasController.video;

                _this135.video.pause();

                if (stream.crop) {
                  _this135.canvasController.crop = new bg.Vector4(stream.crop.left, stream.crop.top, stream.crop.right, stream.crop.bottom);
                }

                if (stream.displacement) {
                  _this135.canvasController.transform = bg.Matrix4.Translation(stream.displacement.x, stream.displacement.y, 0);
                }

                if (stream.chromaColor) {
                  _this135.canvasController.chroma = new bg.Color(stream.chromaColor[0], stream.chromaColor[1], stream.chromaColor[2], stream.chromaColor[3]);
                }

                if (stream.chromaBias) {
                  _this135.canvasController.bias = stream.chromaBias;
                }
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            var result = [];
            var sources = _this136._stream.sources[_this136._streamName];
            var index = -1;
            sources.forEach(function (s) {
              index++;
              result.push(_this136._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this137.video.paused;
          var sources = _this137._stream.sources[_this137._streamName];
          _this137._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this137.video.currentTime;

          _this137.freeze().then(function () {
            _this137._ready = false;
            return _this137.load();
          }).then(function () {
            if (!paused) {
              _this137.play();
            }

            $(_this137.video).on('seeked', function () {
              _this137.unFreeze();

              resolve();
              $(_this137.video).off('seeked');
            });
            _this137.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this138._getQualityObject(_this138._currentQuality, _this138._stream.sources[_this138._streamName][_this138._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this142.video.duration;
        });
      }
    }, {
      key: "setCurrentTime",
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          _this143.video.currentTime = time;
          $(_this143.video).on('seeked', function () {
            _this143.canvasController.postRedisplay();

            $(_this143.video).off('seeked');
          });
        });
      }
    }, {
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this144.video.currentTime;
        });
      }
    }, {
      key: "setVolume",
      ...
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this147.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this148.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this150.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
      ...
      _createClass(FootPrintsPlugin, [{
        ...
        value: function onTimeUpdate() {
          ...
          paella.player.videoContainer.currentTime().then(function (c) {
            ...
            if (_this151.inPosition <= videoCurrentTime && videoCurrentTime <= _this151.inPosition + _this151.INTERVAL_LENGTH) {
              _this151.outPosition = videoCurrentTime;

              if (_this151.inPosition + _this151.INTERVAL_LENGTH === _this151.outPosition) {
                _this151.trackFootPrint(_this151.inPosition, _this151.outPosition);

                _this151.inPosition = _this151.outPosition;
              }
            } else {
              _this151.trackFootPrint(_this151.inPosition, _this151.outPosition);

              _this151.inPosition = videoCurrentTime;
              _this151.outPosition = videoCurrentTime;
            }
          });
        }
      ...
      _createClass(FrameControlPlugin, [{
        ...
        value: function buildContent(domElement) {
          ...
          paella.events.bind(paella.events.setTrim, function (event, params) {
            _this152.updateFrameVisibility(params.trimEnabled, params.trimStart, params.trimEnd);
          });
          paella.player.videoContainer.trimming().then(function (trimData) {
            _this152.updateFrameVisibility(trimData.enabled, trimData.start, trimData.end);
          });
          paella.events.bind(paella.events.timeupdate, function (event, params) {
            return _this152.onTimeUpdate(params.currentTime);
          });
        }
      }, {
        key: "showHiResFrame",
        ...
        value: function onMouseOut(event, frameData) {
          ...
          this._searchTimer = setTimeout(function (timer) {
            return _this153.removeHiResFrame();
        ...
        value: function onTimeUpdate(currentTime) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            ...
            for (var i = 0; i < _this154.frames.length; ++i) {
              if (_this154.frames[i].frameData && _this154.frames[i].frameData.time <= time) {
                frame = _this154.frames[i];
              } else {
                break;
              }
            }

            if (_this154.currentFrame != frame && frame) {
              //this.navButtons.left.scrollContainer.scrollLeft += 100;
              if (_this154.currentFrame) _this154.currentFrame.className = 'frameControlItem';
              _this154.currentFrame = frame;
              _this154.currentFrame.className = 'frameControlItem current';
            }
          });
        }
      }, {
      ...
      _createClass(FullScreenPlugin, [{
        ...
        value: function setup() {
          ...
          paella.events.bind(paella.events.enterFullscreen, function (event) {
            return _this155.onEnterFullscreen();
          });
          paella.events.bind(paella.events.exitFullscreen, function (event) {
            return _this155.onExitFullscreen();
          });
        }
      }, {
        key: "action",
        value: function action(button) {
          ...
          if (paella.player.isFullScreen()) {
            ...
            paella.player.pause();
            paella.player.videoContainer.currentTime().then(function (currentTime) {
              var obj = _this156.secondsToHours(currentTime);
    ...
    _createClass(HLSPlayer, [{
      ...
      value: function load() {
        ...
        if (base.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve, reject) {
            var source = _this157._stream.sources.hls;

            if (source && source.length > 0) {
              source = source[0];

              _this157._loadDeps().then(function (Hls) {
                if (Hls.isSupported()) {
      ...
      value: function getQualities() {
        ...
        if (base.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve) {
            if (!_this158._qualities || _this158._qualities.length == 0) {
              _This2._qualities = [];
              ...
              if (_this158._qualities.length > 1) {
      ...
      value: function printQualityes() {
        ...
        return new Promise(function (resolve, reject) {
          _this159.getCurrentQuality().then(function (cq) {
            return _this159.getNextQuality();
          }).then(function (nq) {
            resolve();
          });
        });
      ...
      value: function getNextQuality() {
        ...
        return new Promise(function (resolve, reject) {
          var index = _this160.qualityIndex;
          resolve(_this160._qualities[index]);
        });
      }
    }, {
      key: "getCurrentQuality",
      value: function getCurrentQuality() {
        ...
        if (base.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve, reject) {
            resolve(_this161._qualities[_this161.qualityIndex]);
          });
        }
      }
    }]);
...
(function () {
  var MpegDashVideo = /*#__PURE__*/function (_paella$Html5Video2) {
    ...
    function MpegDashVideo(id, stream, left, top, width, height) {
      ...
      _this162 = _possibleConstructorReturn(this, _getPrototypeOf(MpegDashVideo).call(this, id, stream, left, top, width, height));
      _this162._posterFrame = null;
      _this162._player = null;
      return _this162;
    }
    ...
    _createClass(MpegDashVideo, [{
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          var source = _this163._stream.sources.mpd;

          if (source && source.length > 0) {
            source = source[0];

            _this163._loadDeps().then(function () {
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve) {
          _this164._deferredAction(function () {
            if (!_this164._qualities) {
              _this164._qualities = [];

              _this164._player.getBitrateInfoListFor("video").sort(function (a, b) {
                return a.bitrate - b.bitrate;
              }).forEach(function (item, index, bitrates) {
                _this164._qualities.push(_this164._getQualityObject(item, index, bitrates));
              });

              _this164.autoQualityIndex = _this164._qualities.length;

              _this164._qualities.push({
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          var currentQuality = _this165._player.getQualityFor("video");

          if (index == _this165.autoQualityIndex) {
            _this165._player.setAutoSwitchQuality(true);

            resolve();
          } else if (index != currentQuality) {
            _this165._player.setAutoSwitchQuality(false);

            _this165._player.off(dashjs.MediaPlayer.events.METRIC_CHANGED);

            _this165._player.on(dashjs.MediaPlayer.events.METRIC_CHANGED, function (a, b) {
              if (a.type == "metricchanged") {
                if (currentQuality != _this165._player.getQualityFor("video")) {
                  currentQuality = _this165._player.getQualityFor("video");
                  resolve();
                }
              }
            });

            _this165._player.setQualityFor("video", index);
          } else {
            resolve();
          }
        });
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          if (_this166._player.getAutoSwitchQuality()) {
            // auto quality
            resolve({
              index: _this166.autoQualityIndex,
              res: {
                w: null,
                h: null
              },
            ...
            var index = _this166._player.getQualityFor("video");

            resolve(_this166._getQualityObject(_this166._qualities[index], index, _this166._player.getBitrateInfoListFor("video")));
          }
        });
      }
    }, {
      ...
      _createClass(MultipleQualitiesPlugin, [{
        ...
        value: function setup() {
          ...
          paella.events.bind(paella.events.qualityChanged, function (event) {
            return _this168.setQualityLabel();
          });
        }
      }, {
        key: "getButtonType",
        ...
        value: function buildContent(domElement) {
          ...
          this._available.forEach(function (q) {
            ...
            domElement.appendChild(_this169.getItemButton(q));
          });
        }
      }, {
        key: "getItemButton",
        value: function getItemButton(quality) {
          ...
          paella.player.videoContainer.getCurrentQuality().then(function (currentIndex, currentData) {
            ...
            elem.className = _this170.getButtonItemClass(label, quality.index == currentIndex);
            elem.id = label;
            elem.innerText = label;
            elem.data = quality;
            $(elem).click(function (event) {
...
paella.addPlugin(function () {
  return (/*#__PURE__*/function (_paella$ButtonPlugin13) {
      ...
      function PlayPauseButtonPlugin() {
        ...
        _this172 = _possibleConstructorReturn(this, _getPrototypeOf(PlayPauseButtonPlugin).call(this));
        _this172.playIconClass = 'icon-play';
        _this172.pauseIconClass = 'icon-pause';
        _this172.playSubclass = 'playButton';
        _this172.pauseSubclass = 'pauseButton';
        return _this172;
      }
      ...
      _createClass(PlayPauseButtonPlugin, [{
        ...
        value: function setup() {
          ...
          paella.events.bind(paella.events.play, function (event) {
            _this173.changeIconClass(_this173.pauseIconClass);

            _this173.changeSubclass(_this173.pauseSubclass);

            _this173.setToolTip(paella.dictionary.translate("Pause"));
          });
          paella.events.bind(paella.events.pause, function (event) {
            _this173.changeIconClass(_this173.playIconClass);

            _this173.changeSubclass(_this173.playSubclass);

            _this173.setToolTip(paella.dictionary.translate("Play"));
          });
...
paella.addPlugin(function () {
  return (/*#__PURE__*/function (_paella$EventDrivenPl9) {
      ...
      function PlayButtonOnScreen() {
        ...
        _this174 = _possibleConstructorReturn(this, _getPrototypeOf(PlayButtonOnScreen).call(this));
        _this174.containerId = 'paella_plugin_PlayButtonOnScreen';
        _this174.container = null;
        _this174.enabled = true;
        _this174.isPlaying = false;
        _this174.showIcon = true;
        _this174.firstPlay = false;
        return _this174;
      }
      ...
      _createClass(PlayButtonOnScreen, [{
        ...
        value: function setup() {
          ...
          $(this.container).click(function () {
            return _this175.onPlayButtonClick();
          });
        }
      }, {
        key: "getEvents",
      ...
      _createClass(PlaybackRate, [{
        ...
        value: function buildContent(domElement) {
          ...
          this.available_rates.forEach(function (rate) {
            domElement.appendChild(_this176.getItemButton(rate + "x", rate));
          });
        }
      }, {
        key: "getItemButton",
      ...
      _createClass(RatePlugin, [{
        ...
        value: function checkEnabled(onSuccess) {
          ...
          paella.data.read('rate', {
            ...
            if (data && _typeof(data) == 'object') {
              _this177.score = Number(data.mean).toFixed(1);
              _this177.count = data.count;
              _this177.myScore = data.myScore;
              _this177.canVote = data.canVote;
            }
        ...
        value: function vote(score) {
          ...
          paella.data.write('rate', {
            ...
            paella.data.read('rate', {
              ...
              if (data && _typeof(data) == 'object') {
                _this178.score = Number(data.mean).toFixed(1);
                _this178.count = data.count;
                _this178.myScore = data.myScore;
                _this178.canVote = data.canVote;
              }

              _this178.updateHeader();

              _this178.updateRateButtons();
            });
          });
        }
      }, {
        ...
        value: function updateVote() {
          ...
          this.buttons.forEach(function (item, index) {
            item.className = index < _this179.myScore ? "starButton glyphicon glyphicon-star" : "starButton glyphicon glyphicon-star-empty";
          });
        }
      }]);
...
(function () {
  var RTMPVideo = /*#__PURE__*/function (_paella$VideoElementB5) {
    ...
    function RTMPVideo(id, stream, left, top, width, height) {
      ...
      _this180 = _possibleConstructorReturn(this, _getPrototypeOf(RTMPVideo).call(this, id, stream, 'div', left, top, width, height));
      _this180._posterFrame = null;
      _this180._currentQuality = null;
      _this180._duration = 0;
      _this180._paused = true;
      _this180._streamName = null;
      _this180._flashId = null;
      _this180._swfContainer = null;
      _this180._flashVideo = null;
      _this180._volume = 1;
      _this180._flashId = id + 'Movie';
      _this180._streamName = 'rtmp';

      var This = _assertThisInitialized(_this180);

      _this180._stream.sources.rtmp.sort(function (a, b) {
        return a.res.h - b.res.h;
      });
    ...
    _createClass(RTMPVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this181.ready) {
            ...
            $(_this181.swfContainer).bind('paella:flashvideoready', function () {
              _this181._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          _this182._deferredAction(function () {
            var videoData = {
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            var result = [];
            var sources = _this183._stream.sources.rtmp;
            var index = -1;
            sources.forEach(function (s) {
              index++;
              result.push(_this183._getQualityObject(index, s));
            });
            resolve(result);
          }, 50);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          var paused = _this184._paused;
          var sources = _this184._stream.sources.rtmp;
          _this184._currentQuality = index < sources.length ? index : 0;
          var source = sources[index];
          _this184._ready = false;
          _this184._isReady = false;

          _this184.load().then(function () {
            resolve();
          });
        });
      }
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          resolve(_this185._getQualityObject(_this185._currentQuality, _this185._stream.sources.rtmp[_this185._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      _createClass(SocialPlugin, [{
        ...
        value: function buildContent(domElement) {
          ...
          this.socialMedia.forEach(function (mediaData) {
            var buttonItem = _this186.getSocialMediaItemButton(mediaData);

            _this186.buttonItems[_this186.socialMedia.indexOf(mediaData)] = buttonItem;
            domElement.appendChild(buttonItem);

            _this186.buttons.push(buttonItem);
          });
  ...
  paella.addPlugin(function () {
    return (/*#__PURE__*/function (_paella$EventDrivenPl10) {
        ...
        function Track4KPlugin() {
          ...
          _this187 = _possibleConstructorReturn(this, _getPrototypeOf(Track4KPlugin).call(this));
          g_track4kPlugin = _assertThisInitialized(_this187);
          _this187._videoData = {};
          _this187._trackData = [];
          _this187._enabled = true;
          return _this187;
        }
        ...
        _createClass(Track4KPlugin, [{
          ...
          value: function checkEnabled(cb) {
            ...
            paella.data.read('cameraTrack', {
              ...
              if (data) {
                _this188._videoData.width = data.width;
                _this188._videoData.height = data.height;
                _this188._videoData.originalWidth = data.originalWidth;
                _this188._videoData.originalHeight = data.originalHeight;
                _this188._trackData = data.positions;
                _this188._enabled = true;
              } else {
                _this188._enabled = false;
              }

              cb(_this188._enabled);
            });
          }
        }, {
          key: "getName",
        ...
        _createClass(VideoZoomTrack4KPlugin, [{
          ...
          value: function buildContent(domElement) {
            ...
            domElement.appendChild(getZoomButton('zoom-auto', function (evt) {
              ...
              paella.player.controls.hidePopUp(_this189.getName());
            }, "auto"));
          }
        }, {
          key: "zoomIn",
      ...
      _createClass(ElasticsearchSaverPlugin, [{
        ...
        value: function log(event, params) {
          ...
          paella.player.videoContainer.currentTime().then(function (t) {
            ...
            paella.ajax.post({
              url: _this190._url + "/" + _this190._index + "/" + _this190._type + "/",
...
(function () {
  function buildVideo360Canvas(stream, canvas) {
    var Video360Canvas = /*#__PURE__*/function (_bg$app$WindowControl3) {
      ...
      function Video360Canvas(stream) {
        ...
        _this191 = _possibleConstructorReturn(this, _getPrototypeOf(Video360Canvas).call(this));
        _this191.stream = stream;
        return _this191;
      }
      ...
      _createClass(Video360Canvas, [{
        ...
        value: function buildScene() {
          ...
          bg.base.Loader.RegisterPlugin(new bg.base.VWGLBLoaderPlugin());
          bg.base.Loader.Load(this.gl, this.stream.src).then(function (texture) {
            _this193.texture = texture;
            var sphere = bg.scene.PrimitiveFactory.Sphere(_this193.gl, 1, 50);
            var sphereNode = new bg.scene.Node(_this193.gl);
            sphereNode.addComponent(sphere);
            ...
            _this193._root.addChild(sphereNode);
          });
          var lightNode = new bg.scene.Node(this.gl, "Light");
  ...
  var Video360 = /*#__PURE__*/function (_paella$VideoElementB6) {
    ...
    function Video360(id, stream, left, top, width, height, streamName) {
      ...
      _this194 = _possibleConstructorReturn(this, _getPrototypeOf(Video360).call(this, id, stream, 'canvas', 0, 0, 1280, 720));
      _this194._posterFrame = null;
      _this194._currentQuality = null;
      _this194._autoplay = false;
      _this194._streamName = null;
      _this194._streamName = streamName || 'video360';

      var This = _assertThisInitialized(_this194);

      paella.player.videoContainer.disablePlayOnClick();

      if (_this194._stream.sources[_this194._streamName]) {
        _this194._stream.sources[_this194._streamName].sort(function (a, b) {
          return a.res.h - b.res.h;
        });
      }
    ...
    _createClass(Video360, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this195.video) {
            ...
            $(_this195.video).bind('canplay', function () {
              _this195._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this196._deferredAction(function () {
            resolve({
              duration: This.video.duration,
              currentTime: This.video.currentTime,
              volume: This.video.volume,
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          var sources = _this197._stream.sources[_this197._streamName];

          if (_this197._currentQuality === null && _this197._videoQualityStrategy) {
            _this197._currentQuality = _this197._videoQualityStrategy.getQualityIndex(sources);
          }

          var stream = _this197._currentQuality < sources.length ? sources[_this197._currentQuality] : null;
          paella.getVideoCanvas().then(function (WebGLVideoCanvas) {
            var MyWebGLVideoCanvas = /*#__PURE__*/function (_WebGLVideoCanvas) {
            ...
            if (stream) {
              _this197.canvasController = null;
              var controller = new MyWebGLVideoCanvas(stream);
              var mainLoop = bg.app.MainLoop.singleton;
              mainLoop.updateMode = bg.app.FrameUpdate.AUTO;
              mainLoop.canvas = _this197.domElement;
              mainLoop.run(controller);
              return controller.loaded();
            } else {
              reject(new Error("Could not load video: invalid quality stream index"));
            ...
            _this197.canvasController = canvasController;
            _this197.video = canvasController.video;

            _this197.video.pause();

            _this197.disableEventCapture();
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            var result = [];
            var sources = _this198._stream.sources[_this198._streamName];
            var index = -1;
            sources.forEach(function (s) {
              index++;
              result.push(_this198._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this199.video.paused;
          var sources = _this199._stream.sources[_this199._streamName];
          _this199._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this199.video.currentTime;

          _this199.freeze().then(function () {
            _this199._ready = false;
            return _this199.load();
          }).then(function () {
            if (!paused) {
              _this199.play();
            }

            $(_this199.video).on('seeked', function () {
              _this199.unFreeze();

              resolve();
              $(_this199.video).off('seeked');
            });
            _this199.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this200._getQualityObject(_this200._currentQuality, _this200._stream.sources[_this200._streamName][_this200._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this204.video.duration;
        });
      }
    }, {
      key: "setCurrentTime",
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          _this205.video.currentTime = time;
          $(_this205.video).on('seeked', function () {
            _this205.canvasController.postRedisplay();

            $(_this205.video).off('seeked');
          });
        });
      }
    }, {
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this206.video.currentTime;
        });
      }
    }, {
      key: "setVolume",
      ...
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this209.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this210.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this212.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
  ...
  var Video360Factory = /*#__PURE__*/function (_paella$VideoFactory6) {
...
(function () {
  function buildVideo360ThetaCanvas(stream, canvas) {
    ...
    var Video360ThetaCanvas = /*#__PURE__*/function (_bg$app$WindowControl4) {
      ...
      function Video360ThetaCanvas(stream) {
        ...
        _this213 = _possibleConstructorReturn(this, _getPrototypeOf(Video360ThetaCanvas).call(this));
        _this213.stream = stream;
        return _this213;
      }
      ...
      _createClass(Video360ThetaCanvas, [{
        ...
        value: function buildScene() {
          ...
          bg.base.Loader.RegisterPlugin(new bg.base.VWGLBLoaderPlugin());
          bg.base.Loader.Load(this.gl, this.stream.src).then(function (texture) {
            _this215.texture = texture; //let sphere = bg.scene.PrimitiveFactory.Sphere(this.gl,1,50);
            //let sphereNode = new bg.scene.Node(this.gl);

            var viewerNode = buildViewerNode(_this215.gl);
            ...
            _this215._root.addChild(viewerNode);

            _this215.postRedisplay();
          });
          var lightNode = new bg.scene.Node(this.gl, "Light");
  ...
  var Video360Theta = /*#__PURE__*/function (_paella$VideoElementB7) {
    ...
    function Video360Theta(id, stream, left, top, width, height, streamName) {
      ...
      _this216 = _possibleConstructorReturn(this, _getPrototypeOf(Video360Theta).call(this, id, stream, 'canvas', 0, 0, 1280, 720));
      _this216._posterFrame = null;
      _this216._currentQuality = null;
      _this216._autoplay = false;
      _this216._streamName = null;
      _this216._streamName = streamName || 'video360theta';

      var This = _assertThisInitialized(_this216);

      paella.player.videoContainer.disablePlayOnClick();

      if (_this216._stream.sources[_this216._streamName]) {
        _this216._stream.sources[_this216._streamName].sort(function (a, b) {
          return a.res.h - b.res.h;
        });
      }
    ...
    _createClass(Video360Theta, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this217.video) {
            ...
            $(_this217.video).bind('canplay', function () {
              _this217._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this218._deferredAction(function () {
            resolve({
              duration: This.video.duration,
              currentTime: This.video.currentTime,
              volume: This.video.volume,
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this219._loadDeps().then(function () {
            var sources = _this219._stream.sources[_this219._streamName];

            if (_this219._currentQuality === null && _this219._videoQualityStrategy) {
              _this219._currentQuality = _this219._videoQualityStrategy.getQualityIndex(sources);
            }

            var stream = _this219._currentQuality < sources.length ? sources[_this219._currentQuality] : null;
            _this219.video = null;

            if (stream) {
              _this219.canvasController = null;
              buildVideo360ThetaCanvas(stream, _this219.domElement).then(function (canvasController) {
                _this219.canvasController = canvasController;
                _this219.video = canvasController.video;

                _this219.video.pause();

                _this219.disableEventCapture();
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            var result = [];
            var sources = _this220._stream.sources[_this220._streamName];
            var index = -1;
            sources.forEach(function (s) {
              index++;
              result.push(_this220._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this221.video.paused;
          var sources = _this221._stream.sources[_this221._streamName];
          _this221._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this221.video.currentTime;

          _this221.freeze().then(function () {
            _this221._ready = false;
            return _this221.load();
          }).then(function () {
            if (!paused) {
              _this221.play();
            }

            $(_this221.video).on('seeked', function () {
              _this221.unFreeze();

              resolve();
              $(_this221.video).off('seeked');
            });
            _this221.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this222._getQualityObject(_this222._currentQuality, _this222._stream.sources[_this222._streamName][_this222._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this226.video.duration;
        });
      }
    }, {
      key: "setCurrentTime",
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          _this227.video.currentTime = time;
          $(_this227.video).on('seeked', function () {
            _this227.canvasController.postRedisplay();

            $(_this227.video).off('seeked');
          });
        });
      }
    }, {
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this228.video.currentTime;
        });
      }
    }, {
      key: "setVolume",
      ...
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this231.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this232.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this234.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
  ...
  var Video360ThetaFactory = /*#__PURE__*/function (_paella$VideoFactory7) {
      ...
      _createClass(VideoZoomPlugin, [{
        ...
        value: function setup() {
          ...
          players.forEach(function (player, index) {
            if (player.allowZoom()) {
              _this235._available = player.zoomAvailable();
              _this235._visible = _this235._available;
              setupButtons.apply(_this235, [player]);
              player.supportsCaptureFrame().then(function (supports) {
                if (supports) {
                  var thumbContainer = document.createElement('div');
                  thumbContainer.className = "zoom-container";
                  var thumb = getThumbnailContainer.apply(_this235, [index]);
                  var zoomRect = getZoomRect.apply(_this235);

                  _this235.button.appendChild(thumbContainer);

                  thumbContainer.appendChild(thumb);
                  thumbContainer.appendChild(zoomRect);
                  $(thumbContainer).hide();

                  _this235._thumbnails.push({
                    player: player,
                  ...
                  checkVisibility.apply(_this235);
                }
              });
            }
          });
          ...
          paella.events.bind(paella.events.play, function (evt) {
            var updateThumbs = function updateThumbs() {
              _this235._thumbnails.forEach(function (item) {
          ...
          paella.events.bind(paella.events.videoZoomChanged, function (evt, target) {
            _this235._thumbnails.some(function (thumb) {
          ...
          paella.events.bind(paella.events.zoomAvailabilityChanged, function (evt, target) {
            _this235._available = target.available;
            _this235._visible = target.available;
            checkVisibility.apply(_this235);
          });
          paella.events.bind(paella.events.controlBarDidHide, function () {
            _this235._visible = false;
            checkVisibility.apply(_this235);
          });
          paella.events.bind(paella.events.controlBarDidShow, function () {
            _this235._visible = true;
            checkVisibility.apply(_this235);
          });
        }
      }, {
  ...
  return (/*#__PURE__*/function (_paella$ButtonPlugin20) {
      ...
      _createClass(VideoZoomToolbarPlugin, [{
        ...
        value: function buildContent(domElement) {
          ...
          paella.events.bind(paella.events.videoZoomChanged, function (evt, target) {
            _this236.setText(Math.round(target.video.zoom) + "%");
          });
          this.setText("100%");
          ...
          domElement.appendChild(getZoomButton('zoom-in', function (evt) {
            _this236.targetPlayer.zoomIn();
          }));
          domElement.appendChild(getZoomButton('zoom-out', function (evt) {
            _this236.targetPlayer.zoomOut();
          }));
        }
      }]);
      ...
      _createClass(ViewModePlugin, [{
        ...
        value: function rebuildProfileList() {
          ...
          paella.profiles.profileList.forEach(function (profileData) {
            ...
            if (_this237.active_profiles) {
              var active = false;

              _this237.active_profiles.forEach(function (ap) {
                if (ap == profile) {
                  active = true;
                }
              });
            ...
            var buttonItem = _this237.getProfileItemButton(profileData.id, profileData);

            _this237.buttonItems[profileData.id] = buttonItem;

            _this237.domElement.appendChild(buttonItem);

            _this237.buttons.push(buttonItem);

            if (paella.player.selectedProfile == profileData.id) {
              _this237.buttonItems[profileData.id].className = _this237.getButtonItemClass(profileData.id, true);
            }
          });
          this.selected_button = this.buttons.length;
        }
      ...
      _createClass(VolumeRangePlugin, [{
        ...
        value: function action(button) {
          ...
          paella.player.videoContainer.volume().then(function (v) {
            if (v == 0) {
              paella.player.videoContainer.setVolume(_this239._preMutedVolume);
            } else {
              _this239._preMutedVolume = v;
        ...
        value: function getExpandableContent() {
          ...
          var updateMasterVolume = function updateMasterVolume() {
            ...
            var slaveVolume = 0;
            _this240._control_NotMyselfEvent = false;
        ...
        value: function updateClass() {
          ...
          paella.player.videoContainer.volume().then(function (volume) {
            ...
            _this241.changeIconClass(selected);
          });
        }
      }]);
...
(function () {
  var WebmVideoFactory = /*#__PURE__*/function (_paella$VideoFactory8) {
...
(function () {
  var YoutubeVideo = /*#__PURE__*/function (_paella$VideoElementB8) {
    ...
    function YoutubeVideo(id, stream, left, top, width, height) {
      ...
      _this243 = _possibleConstructorReturn(this, _getPrototypeOf(YoutubeVideo).call(this, id, stream, 'div', left, top, width, height));
      _this243._posterFrame = null;
      _this243._currentQuality = null;
      _this243._autoplay = false;
      _this243._readyPromise = null;
      _this243._readyPromise = $.Deferred();
      return _this243;
    }
    ...
    _createClass(YoutubeVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          _this244._readyPromise.then(function () {
            resolve(action());
          }, function () {
            reject();
          });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          var stream = _this245._stream.sources.youtube[0];

          _this245._deferredAction(function () {
            var videoData = {
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this246._qualityListReadyPromise = $.Deferred();
          paella.youtubePlayerVars.apiReadyPromise.then(function () {
            var stream = _this246._stream.sources.youtube[0];

            if (stream) {
              // TODO: poster frame
              _this246._youtubePlayer = new YT.Player(This.identifier, {
                height: '390',
                width: '640',
                videoId: stream.id,
                playerVars: {
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          _this247._qualityListReadyPromise.then(function (q) {
            for (var key in _this247._qualities) {
              var searchQ = _this247._qualities[key];

              if (_typeof(searchQ) == "object" && searchQ.index == index) {
                _this247.video.setPlaybackQuality(searchQ.label);
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          _this248._qualityListReadyPromise.then(function (q) {
            resolve(_this248._qualities[_this248.video.getPlaybackQuality()]);
          });
        });
      }
    }, {
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          new base.Timer(function (timer) {
            var q = _this249.video.getAvailableQualityLevels();

            if (q.length) {
              timer.repeat = false;

              _this249._qualityListReadyPromise.resolve(q);
      ...
      value: function pause() {
        ...
        return this._deferredAction(function () {
          _this250._playing = false;

          _this250.video.pauseVideo();
        });
      }
    }, {
      key: "isPaused",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this252.video.getDuration();
        });
      }
    }, {
      key: "setCurrentTime",
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this254.video.getCurrentTime();
        });
      }
    }, {
      key: "setVolume",
      value: function setVolume(volume) {
        ...
        return this._deferredAction(function () {
          _this255.video.setVolume && _this255.video.setVolume(volume * 100);
        });
      }
    }, {
      key: "volume",
      value: function volume() {
        ...
        return this._deferredAction(function () {
          return _this256.video.getVolume() / 100;
        });
      }
    }, {
      key: "setPlaybackRate",
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this257.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this258.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this260.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
      ...
      value: function freeze() {
        ...
        return this._deferredAction(function () {
          var canvas = document.createElement("canvas");
          canvas.id = _this261.video.className + "canvas";
          canvas.width = _this261.video.videoWidth;
          canvas.height = _this261.video.videoHeight;
          canvas.style.cssText = _this261.video.style.cssText;
          canvas.style.zIndex = 2;
          var ctx = canvas.getContext("2d");
          ctx.drawImage(_this261.video, 0, 0, Math.ceil(canvas.width / 16) * 16, Math.ceil(canvas.height / 16) * 16); //Draw image

          _this261.video.parentElement.appendChild(canvas);
        });
      }
    }, {
      key: "unload",
  ...
  var YoutubeVideoFactory = /*#__PURE__*/function (_paella$VideoFactory9) {
