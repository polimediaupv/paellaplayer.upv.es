...
paella.player = null;
paella.version = "6.0.4 - build: 2c1b5f4";
...
(function() {
  ...
  var Button = function($__super) {
    function Button(id, className, action, isToggle) {
      ...
      if (isToggle) {
        $(this.domElement).click(($__3 = this, function(event) {
          $__3.toggleIcon();
        }));
      }
  ...
  var MultiformatAudioElement = function($__super) {
    ...
    return ($traceurRuntime.createClass)(MultiformatAudioElement, {
      ...
      isPaused: function() {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          return $__3.audio.paused;
        }]);
      },
      duration: function() {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          return $__3.audio.duration;
        }]);
      },
      setCurrentTime: function(time) {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          $__3.audio.currentTime = time;
        }]);
      },
      currentTime: function() {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          return $__3.audio.currentTime;
        }]);
      },
      setVolume: function(volume) {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          return $__3.audio.volume = volume;
        }]);
      },
      volume: function() {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          return $__3.audio.volume;
        }]);
      },
      setPlaybackRate: function(rate) {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          $__3.audio.playbackRate = rate;
        }]);
      },
      playbackRate: function() {
        var $__3 = this;
        return checkReady.apply(this, [function() {
          return $__3.audio.playbackRate;
        }]);
      },
      unload: function() {
        return Promise.resolve();
    ...
    function Html5Video(id, stream, left, top, width, height, streamName) {
      ...
      if (paella.utils.userAgent.browser.Safari) {
        $(this.video).bind('canplay canplaythrough', ($__5 = this, function(evt) {
          $__5.video.currentTime = $__5._resumeCurrentTime;
        }));
      }
    }
  ...
  var PluginManager = function() {
    function PluginManager() {
      ...
      paella.events.bind(paella.events.loadPlugins, function(event) {
        $__3.loadPlugins("paella.DeferredLoadPlugin");
      });
      var timer = new base.Timer(function() {
        if (paella.player && paella.player.controls && $__3.doResize)
      ...
      addPlugin: function(plugin) {
        ...
        plugin.checkEnabled(function(isEnabled) {
          if (plugin.type == "eventDriven" && isEnabled) {
            ...
            $__3.eventDrivenPlugins.push(plugin);
      ...
      search: function(txt, next) {
        ...
        if (this._index == undefined) {
          ...
          paella.player.videoContainer.trimming().then(function(trimming) {
            $__3._index.search(txt).forEach(function(s) {
  ...
  var YoutubeVideo = function($__super) {
    ...
    return ($traceurRuntime.createClass)(YoutubeVideo, {
      ...
      _deferredAction: function(action) {
        var $__3 = this;
        return new Promise(function(resolve, reject) {
          $__3._readyPromise.then(function() {
            resolve(action());
          }, function() {
            reject();
          });
      ...
      getVideoData: function() {
        ...
        var This = this;
        return new Promise(function(resolve, reject) {
          var stream = $__3._stream.sources.youtube[0];
          $__3._deferredAction(function() {
            var videoData = {
      ...
      load: function() {
        ...
        var This = this;
        return new Promise(function(resolve, reject) {
          $__3._qualityListReadyPromise = $.Deferred();
          paella.youtubePlayerVars.apiReadyPromise.then(function() {
            var stream = $__3._stream.sources.youtube[0];
            if (stream) {
              $__3._youtubePlayer = new YT.Player(This.identifier, {
                height: '390',
                width: '640',
                videoId: stream.id,
                playerVars: {
      ...
      setQuality: function(index) {
        var $__3 = this;
        return new Promise(function(resolve, reject) {
          $__3._qualityListReadyPromise.then(function(q) {
            for (var key in $__3._qualities) {
              var searchQ = $__3._qualities[key];
              if ($traceurRuntime.typeof((searchQ)) == "object" && searchQ.index == index) {
                $__3.video.setPlaybackQuality(searchQ.label);
                break;
              }
            }
            resolve();
      ...
      getCurrentQuality: function() {
        ...
        return new Promise(function(resolve, reject) {
          $__3._qualityListReadyPromise.then(function(q) {
            resolve($__3._qualities[$__3.video.getPlaybackQuality()]);
          });
        });
      },
      play: function() {
        ...
        return new Promise(function(resolve, reject) {
          ...
          new base.Timer(function(timer) {
            var q = $__3.video.getAvailableQualityLevels();
            if (q.length) {
              timer.repeat = false;
              $__3._qualityListReadyPromise.resolve(q);
              resolve();
            } else {
              timer.repeat = true;
            }
      ...
      duration: function() {
        var $__3 = this;
        return this._deferredAction(function() {
          return $__3.video.getDuration();
        });
      },
      setCurrentTime: function(time) {
        var $__3 = this;
        return this._deferredAction(function() {
          $__3.video.seekTo(time);
        });
      },
      currentTime: function() {
        var $__3 = this;
        return this._deferredAction(function() {
          return $__3.video.getCurrentTime();
        });
      },
      setVolume: function(volume) {
        var $__3 = this;
        return this._deferredAction(function() {
          $__3.video.setVolume && $__3.video.setVolume(volume * 100);
        });
      },
      volume: function() {
        var $__3 = this;
        return this._deferredAction(function() {
          return $__3.video.getVolume() / 100;
        });
      },
      setPlaybackRate: function(rate) {
        var $__3 = this;
        return this._deferredAction(function() {
          $__3.video.playbackRate = rate;
        });
      },
      playbackRate: function() {
        var $__3 = this;
        return this._deferredAction(function() {
          return $__3.video.playbackRate;
        });
      },
      goFullScreen: function() {
        var $__3 = this;
      ...
      unFreeze: function() {
        var $__3 = this;
        return this._deferredAction(function() {
          var c = document.getElementById($__3.video.className + "canvas");
          $(c).remove();
        });
      },
      freeze: function() {
        ...
        return this._deferredAction(function() {
          var canvas = document.createElement("canvas");
          canvas.id = $__3.video.className + "canvas";
          canvas.width = $__3.video.videoWidth;
          canvas.height = $__3.video.videoHeight;
          canvas.style.cssText = $__3.video.style.cssText;
          canvas.style.zIndex = 2;
          var ctx = canvas.getContext("2d");
          ctx.drawImage($__3.video, 0, 0, Math.ceil(canvas.width / 16) * 16, Math.ceil(canvas.height / 16) * 16);
          $__3.video.parentElement.appendChild(canvas);
        });
      },
      unload: function() {
        this._callUnloadEvent();
