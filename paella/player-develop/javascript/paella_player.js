...
paella.player = null;
paella.version = "6.3.0 - build: ebbe5b4";
...
(function () {
  ...
  function (_paella$VideoContaine) {
    ...
    function VideoContainer(id) {
      ...
      _this75._audioTag = paella.dictionary.currentLanguage();
    ...
    _createClass(HLSPlayer, [{
      ...
      value: function load() {
        ...
        if (base.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve, reject) {
            var source = _this161._stream.sources.hls;
