...
paella.player = null;
paella.version = "6.5.0 - build: 0d3ff8f";
    ...
    function VideoRect(id, domType, left, top, width, height) {
      ...
      if (zoomEnabled) {
        ...
        $(eventCapture).on('mousemove', function (evt) {
          if (!_this26.allowZoom() || !_this26._zoomAvailable) return; //this.drag = evt.buttons>0;

          if (_this26.drag) {
            paella.player.videoContainer.disablePlayOnClick();
            var mouse = mousePos(evt);
            panImage.apply(_assertThisInitialized(_this26), [{
...
(function () {
  ...
  var VideoContainerBase = /*#__PURE__*/function (_paella$DomNode7) {
    ...
    function VideoContainerBase(id) {
      ...
      _this66._playOnClickEnabled = true;
    ...
    _createClass(VideoContainerBase, [{
      ...
      value: function seekTo(newPositionPercent) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          paella.player.videoContainer.currentTime().then(function (t) {
            ...
            if (_this69._seekTimeLimit > 0 && _this69._seekType == paella.SeekType.BACKWARDS_ONLY) {
              time = _this69._seekTimeLimit;
            }
            ...
            _this69.setCurrentPercent(newPositionPercent).then(function (timeData) {
              _this69._force = true;
      ...
      value: function seekToTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            if (_this70._seekTimeLimit && _this70._seekType == paella.SeekType.BACKWARDS_ONLY) {
              currentTime = _this70._seekTimeLimit;
            }
            ...
            _this70.setCurrentTime(time).then(function (timeData) {
              _this70._force = true;
      ...
      value: function trimStart() {
        ...
        return new Promise(function (resolve) {
          resolve(_this71._trimming.start);
        });
      }
    }, {
      key: "trimEnd",
      ...
      value: function trimEnabled() {
        ...
        return new Promise(function (resolve) {
          resolve(_this73._trimming.enabled);
        });
      }
    }, {
      key: "trimming",
      ...
      value: function setTrimming(start, end) {
        ...
        return new Promise(function (resolve) {
          ...
          _this75.currentTime(true).then(function (c) {
            currentTime = c;
            return _this75.duration();
          }).then(function (duration) {
            _this75._trimming.start = Math.floor(start);
            _this75._trimming.end = Math.floor(end);

            if (_this75._trimming.enabled) {
              if (currentTime < _this75._trimming.start) {
                _this75.setCurrentTime(0);
              }

              if (currentTime > _this75._trimming.end) {
                _this75.setCurrentTime(duration);
              }
            ...
            paella.events.trigger(paella.events.setTrim, {
              trimEnabled: _this75._trimming.enabled,
              trimStart: _this75._trimming.start,
              trimEnd: _this75._trimming.end
            });
            resolve();
          });
        });
      ...
      value: function setCurrentPercent(percent) {
        ...
        return new Promise(function (resolve) {
          _this76.duration().then(function (d) {
            ...
            return _this76.setCurrentTime(position);
    ...
    _createClass(StreamProvider, [{
      ...
      value: function init(videoData) {
        ...
        this._videoData.forEach(function (stream, index) {
          ...
          if (stream.role == 'master') {
            _this78._mainStream = stream;
          }

          if (stream.type == 'video') {
            _this78._videoStreams.push(stream);
          } else if (stream.type == 'audio') {
            _this78._audioStreams.push(stream);
          }
        });
        ...
        this._videoStreams.forEach(function (videoStream, index) {
          ...
          player.setVideoQualityStrategy(_this78._qualityStrategy);
          player.setAutoplay(autoplay);

          if (videoStream == _this78._mainStream) {
            _this78._mainPlayer = player;
            _this78._audioPlayer = player;
          } else {
            player.setVolume(0);
          }

          _this78._videoPlayers.push(player);

          _this78._players.push(player);
        }); // Create audio player
        ...
        this._audioStreams.forEach(function (audioStream, index) {
          ...
          if (player) {
            _this78._audioPlayers.push(player);
      ...
      value: function startVideoSync(syncProviderPlayer) {
        ...
        var sync = function sync() {
          _this79._syncProviderPlayer.currentTime().then(function (t) {
            _this79.players.forEach(function (player) {
          ...
          _this79._syncTimer = setTimeout(function () {
            return sync();
          }, 1000);
        };
      ...
      value: function callPlayerFunction(fnName) {
        ...
        return new Promise(function (resolve, reject) {
          Promise.all(promises).then(function () {
            if (fnName == 'play' && !_this80._firstPlay) {
              _this80._firstPlay = true;

              if (_this80._startTime) {
                _this80.players.forEach(function (p) {
                  return p.setCurrentTime(_this80._startTime);
                });
              }
            }
  ...
  var VideoContainer = /*#__PURE__*/function (_paella$VideoContaine) {
    ...
    function VideoContainer(id) {
      ...
      _this81 = _super21.call(this, id);
      _this81._streamProvider = new paella.StreamProvider();
      _this81._ready = false;
      _this81._videoWrappers = [];
      _this81._container = new paella.DomNode('div', 'playerContainer_videoContainer_container', {
        position: 'relative',
        display: 'block',
        marginLeft: 'auto',
        marginRight: 'auto',
      ...
      _this81._container.domElement.setAttribute('role', 'main');

      _this81.addNode(_this81._container);

      _this81.overlayContainer = new paella.VideoOverlay(_this81.domElement);

      _this81.container.addNode(_this81.overlayContainer);

      _this81.setProfileFrameStrategy(paella.ProfileFrameStrategy.Factory());

      _this81.setVideoQualityStrategy(paella.VideoQualityStrategy.Factory());

      _this81._audioTag = paella.player.config.player.defaultAudioTag || paella.utils.dictionary.currentLanguage();
    ...
    _createClass(VideoContainer, [{
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          _this82.ended().then(function (ended) {
            if (ended) {
              _this82._streamProvider.startTime = 0;

              _this82.seekToTime(0);
            } else {
              _this82.streamProvider.startTime = _this82._startTime;
            }

            return _this82.streamProvider.callPlayerFunction('play');
          }).then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "play", _this82).call(_this82);
      ...
      value: function pause() {
        ...
        return new Promise(function (resolve, reject) {
          _this83.streamProvider.callPlayerFunction('pause').then(function () {
            _get(_getPrototypeOf(VideoContainer.prototype), "pause", _this83).call(_this83);
      ...
      value: function setCurrentTime(time) {
        ...
        return new Promise(function (resolve, reject) {
          _this84.trimming().then(function (trimmingData) {
            ...
            return _this84.streamProvider.callPlayerFunction('setCurrentTime', time);
          }).then(function () {
            return _this84.duration(false);
          }).then(function (duration) {
            resolve({
              time: time,
              duration: duration
      ...
      value: function currentTime() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this85.masterVideo().currentTime();
          }).then(function (time) {
            if (trimmingData.enabled) {
      ...
      value: function mute() {
        ...
        return new Promise(function (resolve) {
          ...
          _this86._audioPlayer.setVolume(0).then(function () {
      ...
      value: function unmute() {
        ...
        return new Promise(function (resolve) {
          _this87._muted = false;

          _this87._audioPlayer.setVolume(_this87._volume).then(function () {
            paella.events.trigger(paella.events.setVolume, {
              master: _this87._volume
            });
            resolve();
          });
        });
      ...
      value: function setVolume(params) {
        ...
        if (_typeof(params) == 'object') {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this88._volume = params;

            _this88._audioPlayer.setVolume(params).then(function () {
              paella.events.trigger(paella.events.setVolume, {
                master: params
              });
              resolve(params);
      ...
      value: function duration() {
        ...
        return new Promise(function (resolve) {
          ...
          p.then(function (t) {
            trimmingData = t;
            return _this89.masterVideo().duration();
          }).then(function (duration) {
            if (trimmingData.enabled) {
      ...
      value: function getAudioTags() {
        ...
        return new Promise(function (resolve) {
          var lang = [];
          var p = _this90.streamProvider.players;
      ...
      value: function setAudioTag(lang) {
        ...
        return new Promise(function (resolve) {
          ...
          _this91.streamProvider.players.forEach(function (player) {
            if (!firstAudioPlayer) {
          ...
          if (!audioSet && _this91.streamProvider.mainVideoPlayer) {
            _this91._audioPlayer = _this91.streamProvider.mainVideoPlayer;
          } else if (!audioSet && firstAudioPlayer) {
            _this91._audioPlayer = firstAudioPlayer;
          }

          Promise.all(promises).then(function () {
            return _this91._audioPlayer.setVolume(_this91._volume);
          }).then(function () {
            _this91._audioTag = _this91._audioPlayer.stream.audioTag;
            paella.events.trigger(paella.events.audioTagChanged);

            _this91.streamProvider.startVideoSync(_this91.audioPlayer);
      ...
      value: function setStreamData(videoData) {
        ...
        return new Promise(function (resolve, reject) {
          _this92.streamProvider.init(videoData);
          ...
          videoData.forEach(function (video) {
            ...
            if (video.audioTag == _this92._audioTag) {
              streamDataAudioTag = _this92._audioTag;
            }
          });

          if (streamDataAudioTag != _this92._audioTag && streamDataAudioTag != null) {
            _this92._audioTag = streamDataAudioTag;
          }

          _this92.streamProvider.videoPlayers.forEach(function (player, index) {
            addVideoWrapper.apply(_this92, ['videoPlayerWrapper_' + index, player]);
            player.setAutoplay(_this92.autoplay());
          });

          _this92.streamProvider.loadVideos()["catch"](function (err) {
            reject(err);
          }).then(function () {
            return _this92.setAudioTag(_this92.audioTag);
          }).then(function () {
            var endedTimer = null;

            var setupEndEventTimer = function setupEndEventTimer() {
              _this92.stopTimeupdate();
            ...
            var eventBindingObject = _this92.masterVideo().video || _this92.masterVideo().audio;

            $(eventBindingObject).bind('timeupdate', function (evt) {
              _this92.trimming().then(function (trimmingData) {
                ...
                if (current >= duration) {
                  _this92.streamProvider.callPlayerFunction('pause');
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this93.currentTime().then(function (currentTime) {
            videoData.currentTime = currentTime;
            return _this93.volume();
          }).then(function (v) {
            videoData.volume = v;
            return _this93.duration();
          }).then(function (d) {
            videoData.duration = d;
            return _this93.paused();
          }).then(function (p) {
            videoData.paused = p;
            return _this93.trimming();
          }).then(function (trimming) {
...
(function () {
  var PluginManager = /*#__PURE__*/function () {
    ...
    function PluginManager() {
      ...
      paella.events.bind(paella.events.loadPlugins, function (event) {
        _this94.loadPlugins("paella.DeferredLoadPlugin");
      });
      var timer = new paella.utils.Timer(function () {
        if (paella.player && paella.player.controls && _this94.doResize) paella.player.controls.onresize();
      }, 1000);
      timer.repeat = true;
    }
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          if (plugin.type == "eventDriven" && isEnabled) {
            ...
            _this95.eventDrivenPlugins.push(plugin);
  ...
  var PopUpContainer = /*#__PURE__*/function (_paella$DomNode8) {
    ...
    function PopUpContainer(id, className) {
      ...
      var style = {};
      _this96 = _super25.call(this, 'div', id, style);
      _this96.containers = null;
      _this96.currentContainerId = -1;
      _this96.domElement.className = className;
      _this96.containers = {};
      return _this96;
    }
  ...
  var ButtonPlugin = /*#__PURE__*/function (_paella$UIPlugin) {
    ...
    function ButtonPlugin() {
      ...
      _this97.subclass = '';
      _this97.container = null;
      _this97.containerManager = null;
      _this97._domElement = null;
      return _this97;
    }
    ...
    _createClass(ButtonPlugin, [{
      ...
      value: function rebuildMenu() {
        ...
        menuContent.forEach(function (menuItem) {
          _this98.menuContent.appendChild(getButtonItem(menuItem, _this98));
        });
      }
    }, {
      key: "menuContent",
  ...
  var EventDrivenPlugin = /*#__PURE__*/function (_paella$EarlyLoadPlug) {
    ...
    function EventDrivenPlugin() {
      ...
      _this99 = _super30.call(this);

      var events = _this99.getEvents();

      for (var i = 0; i < events.length; ++i) {
        var event = events[i];

        if (event == paella.events.loadStarted) {
          _this99.onEvent(paella.events.loadStarted);
        }
      }
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.loadVideoTexture().then(function (texture) {
              _this102._texture = texture;

              _this102.buildVideoSurface(_this102._root, texture);
            });
      ...
      var WebGLCanvas = /*#__PURE__*/function (_bg$app$WindowControl2) {
        ...
        _createClass(WebGLCanvas, [{
          ...
          value: function buildScene() {
            ...
            this.registerPlugins();
            this.loadVideoTexture().then(function (texture) {
              _this105._texture = texture;

              _this105.buildVideoSurface(_this105._root, texture);
            });
            var lightNode = new bg.scene.Node(this.gl, "Light");
            var light = new bg.base.Light();
            light.ambient = bg.Color.White();
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_paella$utils$AsyncLo2) {
    ...
    function SearchCallback(caption, text) {
      ...
      _this106.name = "captionSearchCallback";
      _this106.caption = caption;
      _this106.text = text;
      return _this106;
    }
      ...
      value: function search(txt, next) {
        ...
        if (this._index == undefined) {
          ...
          paella.player.videoContainer.trimming().then(function (trimming) {
            _this108._index.search(txt).forEach(function (s) {
...
(function () {
  ...
  var SearchCallback = /*#__PURE__*/function (_paella$utils$AsyncLo3) {
    ...
    function SearchCallback(plugin, text) {
      ...
      _this109 = _super36.call(this);
      _this109.name = "searchCallback";
      _this109.plugin = plugin;
      _this109.text = text;
      return _this109;
    }
...
(function () {
  var TimeControl = /*#__PURE__*/function (_paella$DomNode9) {
    ...
    function TimeControl(id) {
      ...
      _this112 = _super39.call(this, 'div', id, {
        left: "0%"
      });
      _this112.domElement.className = 'timeControlOld';
      _this112.domElement.className = 'timeControl'; //this.domElement.innerText = "0:00:00";
    ...
    _createClass(PlaybackBarCanvas, [{
      ...
      value: function drawCanvas() {
        ...
        paella.player.videoContainer.duration(true).then(function (d) {
          ...
          var ctx = _this114.context;
          var w = _this114.width;
          var h = _this114.height;

          _this114.clearCanvas();

          _this114._plugins.forEach(function (plugin) {
  ...
  var PlaybackBar = /*#__PURE__*/function (_paella$DomNode10) {
    ...
    function PlaybackBar(id) {
      ...
      var style = {};
      _this116 = _super41.call(this, 'div', id, style);
      _this116.playbackFullId = '';
      _this116.updatePlayBar = true;
      _this116.timeControlId = '';
      _this116._images = null;
      _this116._prev = null;
      _this116._next = null;
      _this116._videoLength = null;
      _this116._lastSrc = null;
      _this116._aspectRatio = 1.777777778;
      _this116._hasSlides = null;
      _this116._imgNode = null;
      _this116._canvas = null;
      _this116.domElement.className = "playbackBar";

      _this116.domElement.setAttribute("alt", ""); //this.domElement.setAttribute("title", "Timeline Slider");


      _this116.domElement.setAttribute("aria-label", "Timeline Slider");

      _this116.domElement.setAttribute("role", "slider");

      _this116.domElement.setAttribute("aria-valuemin", "0");

      _this116.domElement.setAttribute("aria-valuemax", "100");

      _this116.domElement.setAttribute("aria-valuenow", "0");

      _this116.domElement.setAttribute("tabindex", paella.tabIndex.next);

      $(_this116.domElement).keyup(function (event) {
        var currentTime = 0;
        var duration = 0;
        paella.player.videoContainer.currentTime().then(function (t) {
          currentTime = t;
      ...
      _this116.playbackFullId = id + "_full";
      _this116.timeControlId = id + "_timeControl";
      var playbackFull = new paella.DomNode('div', _this116.playbackFullId, {
        width: '0%'
      });
      playbackFull.domElement.className = "playbackBarFull";

      _this116.addNode(playbackFull);

      _this116.addNode(new paella.TimeControl(_this116.timeControlId));
      ...
      $(_this116.domElement).bind('mousedown', function (event) {
      ...
      if (!paella.utils.userAgent.browser.IsMobileVersion) {
        $(_this116.domElement).bind('mousemove', function (event) {
        ...
        $(_this116.domElement).bind("mouseout", function (event) {
          thisClass.mouseOut(event);
        });
      }

      _this116.domElement.addEventListener('touchstart', function (event) {
        paella.utils.mouseManager.down(thisClass, event);
        event.stopPropagation();
      }, false);

      _this116.domElement.addEventListener('touchmove', function (event) {
        thisClass.movePassive(event);
        paella.utils.mouseManager.move(event);
      }, false);

      _this116.domElement.addEventListener('touchend', function (event) {
        paella.utils.mouseManager.up(event);
        thisClass.clearTimeOverlay();
      }, false);

      $(_this116.domElement).bind('mouseup', function (event) {
        paella.utils.mouseManager.up(event);
      });
      ...
      _this116._canvas = new PlaybackBarCanvas(_this116.domElement);
      return _this116;
    }
        ...
        return new Promise(function (resolve) {
          paella.player.videoContainer.duration().then(function (duration) {
            ...
            if (!n || Object.keys(n).length === 0) {
              _this117._hasSlides = false;
              return;
            } else {
              _this117._hasSlides = true;
            }

            _this117._images = n; // COPY TO LOCAL

            _this117._videoLength = duration; // SORT KEYS FOR SEARCH CLOSEST

            _this117._keys = Object.keys(_this117._images);
            _this117._keys = _this117._keys.sort(function (a, b) {
  ...
  var PlaybackControl = /*#__PURE__*/function (_paella$DomNode11) {
      ...
      value: function addPlugin(plugin) {
        ...
        plugin.checkEnabled(function (isEnabled) {
          ...
          if (isEnabled) {
            $(plugin.button).show();
            paella.pluginManager.setupPlugin(plugin);
            var id = 'buttonPlugin' + _this119.buttonPlugins.length;

            if (plugin.getButtonType() == paella.ButtonPlugin.type.popUpButton) {
              parent = _this119.popUpPluginContainer.domElement;
              var popUpContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_container');

              _this119.popUpPluginContainer.registerContainer(plugin.getName(), popUpContent, button, plugin);
            } else if (plugin.getButtonType() == paella.ButtonPlugin.type.timeLineButton) {
              parent = _this119.timeLinePluginContainer.domElement;
              var timeLineContent = paella.ButtonPlugin.BuildPluginPopUp(parent, plugin, id + '_timeline');

              _this119.timeLinePluginContainer.registerContainer(plugin.getName(), timeLineContent, button, plugin);
            ...
            _this119.pluginsContainer.domElement.removeChild(plugin.button);
          }
        });
      }
    }]);
    ...
    function PlaybackControl(id) {
      ...
      var style = {};
      _this118 = _super42.call(this, 'div', id, style);
      _this118.playbackBarId = '';
      _this118.pluginsContainer = null;
      _this118._popUpPluginContainer = null;
      _this118._timeLinePluginContainer = null;
      _this118.playbackPluginsWidth = 0;
      _this118.popupPluginsWidth = 0;
      _this118.minPlaybackBarSize = 120;
      _this118.playbackBarInstance = null;
      _this118.buttonPlugins = [];
      _this118.domElement.className = 'playbackControls';
      _this118.playbackBarId = id + '_playbackBar';

      var thisClass = _assertThisInitialized(_this118);

      _this118.pluginsContainer = new paella.DomNode('div', id + '_playbackBarPlugins');
      _this118.pluginsContainer.domElement.className = 'playbackBarPlugins';

      _this118.pluginsContainer.domElement.setAttribute("role", "toolbar");

      _this118.addNode(_this118.pluginsContainer);

      _this118.addNode(new paella.PlaybackBar(_this118.playbackBarId));

      paella.pluginManager.setTarget('button', _assertThisInitialized(_this118));
      $(window).mousemove(function (evt) {
        if (_this118._expandedPlugin && $(window).height() - evt.clientY > 50) {
          _this118._expandedPlugin.contract();

          _this118._expandPlugin = null;
        }
      });
      return _this118;
    }
  ...
  var ControlsContainer = /*#__PURE__*/function (_paella$DomNode12) {
    ...
    function ControlsContainer(id) {
      ...
      _this120 = _super43.call(this, 'div', id);
      _this120.playbackControlId = '';
      _this120.editControlId = '';
      _this120.isEnabled = true;
      _this120.autohideTimer = null;
      _this120.hideControlsTimeMillis = 3000;
      _this120.playbackControlInstance = null;
      _this120.videoOverlayButtons = null;
      _this120.buttonPlugins = [];
      _this120._hidden = false;
      _this120._over = false;
      _this120.viewControlId = id + '_view';
      _this120.playbackControlId = id + '_playback';
      _this120.editControlId = id + '_editor';

      _this120.addNode(new paella.PlaybackControl(_this120.playbackControlId));

      var thisClass = _assertThisInitialized(_this120);
      ...
      $(_this120.domElement).bind("mousemove", function (event) {
        thisClass._over = true;
      });
      $(_this120.domElement).bind("mouseout", function (event) {
      ...
      _this120.videoOverlayButtons = new paella.DomNode('div', id + '_videoOverlayButtonPlugins');
      _this120.videoOverlayButtons.domElement.className = 'videoOverlayButtonPlugins';

      _this120.videoOverlayButtons.domElement.setAttribute("role", "toolbar");

      _this120.addNode(_this120.videoOverlayButtons);

      paella.pluginManager.setTarget('videoOverlayButton', _assertThisInitialized(_this120));
      return _this120;
    }
...
(function () {
  var LoaderContainer = /*#__PURE__*/function (_paella$DomNode13) {
    ...
    function LoaderContainer(id) {
      ...
      _this123 = _super44.call(this, 'div', id, {
        position: 'fixed',
      ...
      _this123.timer = null;
      _this123.loader = null;
      _this123.loaderPosition = 0;
      _this123.loader = _this123.addNode(new paella.DomNode('i', '', {
        width: "100px",
        height: "100px",
        color: "black",
        display: "block",
      ...
      _this123.loader.domElement.className = "icon-spinner";
      paella.events.bind(paella.events.loadComplete, function (event, params) {
        _this123.loadComplete(params);
      });
      _this123.timer = new paella.utils.Timer(function (timer) {
        //thisClass.loaderPosition -= 128;
        //thisClass.loader.domElement.style.backgroundPosition = thisClass.loaderPosition + 'px';
        _this123.loader.domElement.style.transform = "rotate(".concat(_this123.loaderPosition, "deg");
        _this123.loaderPosition += 45;
      }, 250);
      _this123.timer.repeat = true;
      return _this123;
    }
    ...
    _createClass(KeyManager, [{
      ...
      value: function addPlugin(plugin) {
        ...
        if (plugin.checkEnabled(function (e) {
          _this124._pluginList.push(plugin);
  ...
  var InitDelegate = /*#__PURE__*/function () {
    ...
    _createClass(InitDelegate, [{
      ...
      value: function loadDictionary() {
        ...
        return new Promise(function (resolve) {
          paella.utils.ajax.get({
            url: _this126.initParams.dictionaryUrl + "_" + paella.utils.dictionary.currentLanguage() + '.json'
      ...
      value: function loadConfig() {
        ...
        var loadAccessControl = function loadAccessControl(data) {
          ...
          _this127.initParams.accessControl = new AccessControlClass();
        };

        if (this.initParams.config) {
          return new Promise(function (resolve) {
            loadAccessControl(_this127.initParams.config);
            resolve(_this127.initParams.config);
          });
        } else if (this.initParams.loadConfig) {
          return new Promise(function (resolve, reject) {
            _this127.initParams.loadConfig(_this127.initParams.configUrl).then(function (data) {
          ...
          return new Promise(function (resolve, reject) {
            var configUrl = _this127.initParams.configUrl;
            var params = {};
...
(function () {
  var PaellaPlayer = /*#__PURE__*/function (_paella$PlayerBase) {
    ...
    function PaellaPlayer(playerId) {
      ...
      _this128 = _super46.call(this, playerId);
      _this128.player = null;
      _this128.videoIdentifier = '';
      _this128.loader = null; // Video data:

      _this128.videoData = null; // if initialization ok

      if (_this128.playerId == playerId) {
        _this128.loadPaellaPlayer();

        var thisClass = _assertThisInitialized(_this128);
      }
    ...
    _createClass(PaellaPlayer, [{
      ...
      value: function playing() {
        ...
        return new Promise(function (resolve) {
          _this130.paused().then(function (p) {
            resolve(!p);
          });
        });
      }
  ...
  var LazyThumbnailContainer = /*#__PURE__*/function (_paella$DomNode14) {
    ...
    function LazyThumbnailContainer(src) {
      ...
      _this131 = _super47.call(this, 'img', 'lazyLoadThumbnailContainer', {});
      ...
      _this131.domElement.src = url.absoluteUrl;
      _this131.domElement.alt = "";
      _this131.container = LazyThumbnailContainer.GetIconElement();

      if (!paella.player.videoContainer) {
        document.body.appendChild(_this131.container);
      }
  ...
  var PaellaPlayerLazy = /*#__PURE__*/function (_PaellaPlayer) {
    ...
    function PaellaPlayerLazy(playerId, initDelegate) {
      ...
      _this132 = _super48.call(this, playerId, initDelegate);
      g_lazyLoadInstance = _assertThisInitialized(_this132);
      return _this132;
    }
        ...
        if (this.videoIdentifier) {
          ...
          loader.loadVideo(function () {
            if (!loader.metadata.preview) {
              paella.load(_this133.playerId, paella.loaderFunctionParams);
              g_lazyLoadInstance = null; // Lazy load is disabled when the video has no preview
            } else {
              _this133.lazyLoadContainer = new LazyThumbnailContainer(loader.metadata.preview);
              document.body.appendChild(_this133.lazyLoadContainer.domElement);

              _this133.lazyLoadContainer.onClick(function () {
                _this133.lazyLoadContainer.destroyElements();

                _this133.lazyLoadContainer = null;
                _this133._onPlayClosure && _this133._onPlayClosure();
              });
...
(function () {
  ...
  var DefaultVideoLoader = /*#__PURE__*/function (_paella$VideoLoader) {
    ...
    function DefaultVideoLoader(data) {
      ...
      _this134 = _super49.call(this, data);
      _this134._url = null;
      ...
      if (_typeof(data) == "object") {
        ...
        try {
          _this134._data = JSON.parse(data);
        } catch (e) {
          _this134._url = data;
        }
      }
      ...
      value: function loadVideo(onSuccess) {
        ...
        if (this._data) {
          ...
          loadVideoDelegate().then(function (data) {
            ...
            _this135.loadVideoData(_this135._data, onSuccess);
          });
        } else if (url) {
          var This = this;
          paella.utils.ajax.get({
...
paella.addPlugin(function () {
  var FlexSkipPlugin = /*#__PURE__*/function (_paella$ButtonPlugin2) {
    ...
    var _super53 = _createSuper(FlexSkipPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$plugins$FlexS) {
    ...
    var _super54 = _createSuper(FlexSkipForwardPlugin);
...
paella.addPlugin(function () {
  ...
  return /*#__PURE__*/function (_paella$CaptionParser) {
    ...
    var _super55 = _createSuper(WebVTTParserPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$) {
    ...
    var _super56 = _createSuper(xAPISaverPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl) {
    ...
    var _super57 = _createSuper(SingleStreamProfilePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl2) {
    ...
    var _super58 = _createSuper(DualStreamProfilePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl3) {
    ...
    var _super59 = _createSuper(TripleStreamProfilePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl4) {
    ...
    var _super60 = _createSuper(TrimmingLoaderPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin3) {
    ...
    var _super61 = _createSuper(AirPlayPlugin);
        ...
        if (window.WebKitPlaybackTargetAvailabilityEvent) {
          video.addEventListener('webkitplaybacktargetavailabilitychanged', function (event) {
            switch (event.availability) {
              case "available":
                _this136._visible = true;
                break;

              case "not-available":
                _this136._visible = false;
                break;
            }

            _this136.updateClassName();
          });
        }
      }
    }, {
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl5) {
    ...
    var _super62 = _createSuper(ArrowSlidesNavigator);
        ...
        return new Promise(function (resolve) {
          if (_this137._frames.length < 1) {
            ...
            paella.player.videoContainer.duration().then(function (d) {
              ...
              if (!_this137._frames.some(function (f1, i, array) {
                if (i + 1 == array.length) {
                  return;
                }

                var f0 = i == 0 ? f1 : _this137._frames[i - 1];
                var f2 = _this137._frames[i + 1];
                ...
                var t0 = _this137._frames[_this137._frames.length - 2].time;
                var t1 = _this137._frames[_this137._frames.length - 1].time;
                resolve({
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin4) {
    ...
    var _super63 = _createSuper(AudioSelector);
    ...
    _createClass(AudioSelector, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        this._mainPlayer.supportsMultiaudio().then(function (supports) {
          if (supports) {
            _this138._legacyMode = false;
            return _this138._mainPlayer.getAudioTracks();
          } else {
            _this138._legacyMode = true;
            return paella.player.videoContainer.getAudioTags();
          }
        }).then(function (audioTracks) {
          if (_this138._legacyMode) {
            _this138._tags = audioTracks;
            return Promise.resolve();
          } else {
            _this138._audioTracks = audioTracks;
            return _this138._mainPlayer.getCurrentAudioTrack();
          }
        }).then(function (defaultAudioTrack) {
          if (_this138._legacyMode) {
            onSuccess(_this138._tags.length > 1);
          } else {
            _this138._defaultAudioTrack = defaultAudioTrack;
            onSuccess(true);
          }
        });
      }
        ...
        if (this._legacyMode) {
          this._tags.forEach(function (tag, index) {
            buttonItems.push({
              ...
              value: tag,
              icon: "",
              className: _this139.getButtonItemClass(tag),
          ...
          this._audioTracks.forEach(function (track) {
            buttonItems.push({
              ...
              value: track.id,
              icon: "",
              className: _this139.getButtonItemClass(track.id),
              "default": track.id == _this139._defaultAudioTrack.id
            });
          });
        }
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl6) {
    ...
    var _super64 = _createSuper(BlackBoard2);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl7) {
    ...
    var _super65 = _createSuper(BreaksPlayerPlugin);
    ...
    _createClass(BreaksPlayerPlugin, [{
      ...
      value: function onEvent(eventType, params) {
        ...
        paella.player.videoContainer.currentTime(true).then(function (currentTime) {
          ...
          var diff = Math.abs(currentTime - _this141.lastTime);

          _this141.checkBreaks(currentTime, diff >= 1 ? paella.events.seekToTime : paella.events.timeUpdate);

          _this141.lastTime = currentTime;
        });
      }
    }, {
      key: "checkBreaks",
      value: function checkBreaks(currentTime, eventType) {
        ...
        if (this.breaks.some(function (breakItem) {
          if (breakItem.s <= currentTime && breakItem.e >= currentTime) {
            if (eventType == paella.events.timeUpdate && !_this142.status) {
              _this142.skipTo(breakItem.e);
            }
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$PlaybackCanva) {
    ...
    var _super66 = _createSuper(BufferedPlaybackCanvasPlugin);
...
paella.addPlugin(function () {
  ...
  return /*#__PURE__*/function (_paella$CaptionParser2) {
    ...
    var _super67 = _createSuper(DFXPParserPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin5) {
    ...
    var _super68 = _createSuper(CaptionsPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl8) {
    ...
    var _super69 = _createSuper(CaptionsOnScreen);
      ...
      value: function updateCaptions(time) {
        ...
        if (this.captions) {
          paella.player.videoContainer.trimming().then(function (trimming) {
            ...
            if (caption) {
              $(_this144.container).show();
              _this144.innerContainer.innerText = caption.content;

              _this144.moveCaptionsOverlay("auto");
            } else {
              _this144.innerContainer.innerText = "";

              _this144.hideContent();
            }
          });
        }
      }
...
(function () {
  function buildChromaVideoCanvas(stream, canvas) {
    var ChromaVideoCanvas = /*#__PURE__*/function (_bg$app$WindowControl3) {
      ...
      var _super70 = _createSuper(ChromaVideoCanvas);
      ...
      function ChromaVideoCanvas(stream) {
        ...
        _this145 = _super70.call(this);
        _this145.stream = stream;
        _this145._chroma = bg.Color.White();
        _this145._crop = new bg.Vector4(0.3, 0.01, 0.3, 0.01);
        _this145._transform = bg.Matrix4.Identity().translate(0.6, -0.04, 0);
        _this145._bias = 0.01;
        return _this145;
      }
  ...
  var ChromaVideo = /*#__PURE__*/function (_paella$VideoElementB4) {
    ...
    var _super71 = _createSuper(ChromaVideo);
    ...
    function ChromaVideo(id, stream, left, top, width, height, streamName) {
      ...
      _this148 = _super71.call(this, id, stream, 'canvas', left, top, width, height);
      _this148._posterFrame = null;
      _this148._currentQuality = null;
      _this148._autoplay = false;
      _this148._streamName = null;
      _this148._streamName = streamName || 'chroma';

      var This = _assertThisInitialized(_this148);

      if (_this148._stream.sources[_this148._streamName]) {
        _this148._stream.sources[_this148._streamName].sort(function (a, b) {
          return a.res.h - b.res.h;
        });
      }
    ...
    _createClass(ChromaVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this149.video) {
            ...
            $(_this149.video).bind('canplay', function () {
              _this149._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this150._deferredAction(function () {
            resolve({
              duration: This.video.duration,
              currentTime: This.video.currentTime,
              volume: This.video.volume,
      ...
      value: function load() {
        ...
        var This = this;
        return new Promise(function (resolve, reject) {
          _this151._loadDeps().then(function () {
            var sources = _this151._stream.sources[_this151._streamName];

            if (_this151._currentQuality === null && _this151._videoQualityStrategy) {
              _this151._currentQuality = _this151._videoQualityStrategy.getQualityIndex(sources);
            }

            var stream = _this151._currentQuality < sources.length ? sources[_this151._currentQuality] : null;
            _this151.video = null;
            _this151.domElement.parentNode.style.backgroundColor = "transparent";

            if (stream) {
              _this151.canvasController = null;
              buildChromaVideoCanvas(stream, _this151.domElement).then(function (canvasController) {
                _this151.canvasController = canvasController;
                _this151.video = canvasController.video;

                _this151.video.pause();

                if (stream.crop) {
                  _this151.canvasController.crop = new bg.Vector4(stream.crop.left, stream.crop.top, stream.crop.right, stream.crop.bottom);
                }

                if (stream.displacement) {
                  _this151.canvasController.transform = bg.Matrix4.Translation(stream.displacement.x, stream.displacement.y, 0);
                }

                if (stream.chromaColor) {
                  _this151.canvasController.chroma = new bg.Color(stream.chromaColor[0], stream.chromaColor[1], stream.chromaColor[2], stream.chromaColor[3]);
                }

                if (stream.chromaBias) {
                  _this151.canvasController.bias = stream.chromaBias;
                }
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            ...
            sources.forEach(function (s) {
              index++;
              result.push(_this152._getQualityObject(index, s));
            });
            resolve(result);
          }, 10);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve) {
          var paused = _this153.video.paused;
          var sources = _this153._stream.sources[_this153._streamName];
          _this153._currentQuality = index < sources.length ? index : 0;
          var currentTime = _this153.video.currentTime;

          _this153.freeze().then(function () {
            _this153._ready = false;
            return _this153.load();
          }).then(function () {
            if (!paused) {
              _this153.play();
            }

            $(_this153.video).on('seeked', function () {
              _this153.unFreeze();

              resolve();
              $(_this153.video).off('seeked');
            });
            _this153.video.currentTime = currentTime;
          });
        });
      }
    }, {
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve) {
          resolve(_this154._getQualityObject(_this154._currentQuality, _this154._stream.sources[_this154._streamName][_this154._currentQuality]));
        });
      }
    }, {
      key: "play",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this158.video.duration;
        });
      }
    }, {
      key: "setCurrentTime",
      value: function setCurrentTime(time) {
        ...
        return this._deferredAction(function () {
          _this159.video.currentTime = time;
          $(_this159.video).on('seeked', function () {
            _this159.canvasController.postRedisplay();
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this160.video.currentTime;
        });
      }
    }, {
      key: "setVolume",
      ...
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this163.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this164.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this166.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
  ...
  var ChromaVideoFactory = /*#__PURE__*/function (_paella$VideoFactory2) {
    ...
    var _super72 = _createSuper(ChromaVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin6) {
    ...
    var _super73 = _createSuper(extendedTabAdapterPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin7) {
    ...
    var _super74 = _createSuper(FootPrintsPlugin);
    ...
    _createClass(FootPrintsPlugin, [{
      ...
      value: function onTimeUpdate() {
        ...
        paella.player.videoContainer.currentTime().then(function (c) {
          ...
          if (_this167.inPosition <= videoCurrentTime && videoCurrentTime <= _this167.inPosition + _this167.INTERVAL_LENGTH) {
            _this167.outPosition = videoCurrentTime;

            if (_this167.inPosition + _this167.INTERVAL_LENGTH === _this167.outPosition) {
              _this167.trackFootPrint(_this167.inPosition, _this167.outPosition);

              _this167.inPosition = _this167.outPosition;
            }
          } else {
            _this167.trackFootPrint(_this167.inPosition, _this167.outPosition);

            _this167.inPosition = videoCurrentTime;
            _this167.outPosition = videoCurrentTime;
          }
        });
      }
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$SearchService) {
    ...
    var _super75 = _createSuper(FrameCaptionsSearchPlugIn);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin8) {
    ...
    var _super76 = _createSuper(FrameControlPlugin);
    ...
    _createClass(FrameControlPlugin, [{
      ...
      value: function buildContent(domElement) {
        ...
        paella.events.bind(paella.events.setTrim, function (event, params) {
          _this168.updateFrameVisibility(params.trimEnabled, params.trimStart, params.trimEnd);
        });
        paella.player.videoContainer.trimming().then(function (trimData) {
          _this168.updateFrameVisibility(trimData.enabled, trimData.start, trimData.end);
        });
        paella.events.bind(paella.events.timeupdate, function (event, params) {
          return _this168.onTimeUpdate(params.currentTime);
        });
      }
    }, {
      key: "showHiResFrame",
      ...
      value: function onMouseOut(event, frameData) {
        ...
        this._searchTimer = setTimeout(function (timer) {
          return _this169.removeHiResFrame();
      ...
      value: function onTimeUpdate(currentTime) {
        ...
        paella.player.videoContainer.trimming().then(function (trimming) {
          ...
          for (var i = 0; i < _this170.frames.length; ++i) {
            if (_this170.frames[i].frameData && _this170.frames[i].frameData.time <= time) {
              frame = _this170.frames[i];
            } else {
              break;
            }
          }

          if (_this170.currentFrame != frame && frame) {
            //this.navButtons.left.scrollContainer.scrollLeft += 100;
            if (_this170.currentFrame) _this170.currentFrame.className = 'frameControlItem';
            _this170.currentFrame = frame;
            _this170.currentFrame.className = 'frameControlItem current';
          }
        });
      }
    }, {
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin9) {
    ...
    var _super77 = _createSuper(FullScreenPlugin);
    ...
    _createClass(FullScreenPlugin, [{
      ...
      value: function setup() {
        ...
        paella.events.bind(paella.events.enterFullscreen, function (event) {
          return _this171.onEnterFullscreen();
        });
        paella.events.bind(paella.events.exitFullscreen, function (event) {
          return _this171.onExitFullscreen();
        });
      }
    }, {
      key: "action",
      value: function action(button) {
        ...
        if (paella.player.isFullScreen()) {
          ...
          paella.player.pause();
          paella.player.videoContainer.currentTime().then(function (currentTime) {
            var obj = _this172.secondsToHours(currentTime);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin10) {
    ...
    var _super78 = _createSuper(HelpPlugin);
...
(function () {
  ...
  var HLSPlayer = /*#__PURE__*/function (_paella$Html5Video) {
    ...
    var _super79 = _createSuper(HLSPlayer);
    ...
    function HLSPlayer(id, stream, left, top, width, height) {
      ...
      return _super79.call(this, id, stream, left, top, width, height, 'hls');
    }
    ...
    _createClass(HLSPlayer, [{
        ...
        return new Promise(function (resolve, reject) {
          ...
          if (_this173.ready) {
            ...
            var eventFunction = function eventFunction() {
              processResult(action());
              $(_this173.video).unbind('canplay');
              $(_this173.video).unbind('loadedmetadata');
            ...
            $(_this173.video).bind('canplay', eventFunction);
            $(_this173.video).bind('loadedmetadata', eventFunction);
            ...
            var timerFunction = function timerFunction() {
              if (!_this173.ready) {
                if (!_this173._hls) {
                  ...
                  var src = _this173.video.innerHTML;
                  _this173.video.innerHTML = "";
                  _this173.video.innerHTML = src;
      ...
      value: function setupHls(video, url) {
        ...
        return new Promise(function (resolve, reject) {
          _this174._loadDeps().then(function (Hls) {
            if (Hls.isSupported()) {
              var cfg = _this174.config; //cfg.autoStartLoad = false;

              _this174._hls = new Hls(cfg);

              _this174._hls.loadSource(url);

              _this174._hls.attachMedia(video);

              _this174.autoQuality = true;

              _this174._hls.on(Hls.Events.LEVEL_SWITCHED, function (ev, data) {
                _this174._qualities = _this174._qualities || [];
                _this174._qualityIndex = _this174.autoQuality ? _this174._qualities.length - 1 : data.level;
                paella.events.trigger(paella.events.qualityChanged, {});
                if (console && console.log) console.log("HLS: quality level changed to ".concat(data.level));
              });

              _this174._hls.on(Hls.Events.ERROR, function (event, data) {
                if (data.fatal) {
                  switch (data.type) {
                    ...
                    case Hls.ErrorTypes.MEDIA_ERROR:
                      ...
                      _this174._hls.recoverMediaError();
              ...
              _this174._hls.on(Hls.Events.MANIFEST_PARSED, function () {
                if (!cfg.autoStartLoad) {
                  _this174._hls.startLoad();
                } // Fixes hls.js problems when loading the initial quality level


                _this174._hls.currentLevel = _this174._hls.levels.length >= initialQualityLevel ? initialQualityLevel : -1;
                setTimeout(function () {
                  return _this174._hls.currentLevel = -1;
                }, 1000);
                resolve(video);
              });
            } else {
      ...
      value: function webGlDidLoad() {
        ...
        bg.utils.HTTPResourceProvider.AddVideoLoader('m3u8', function (url, onSuccess, onFail) {
          ...
          _this175.setupHls(video, url).then(function () {
      ...
      value: function loadVideoStream(canvasInstance, stream) {
        ...
        return canvasInstance.loadVideo(this, stream, function (videoElem) {
          return _this176.setupHls(videoElem, stream.src);
        });
      }
    }, {
      key: "supportsMultiaudio",
      value: function supportsMultiaudio() {
        ...
        return this._deferredAction(function () {
          if (paella.utils.userAgent.system.iOS) {
            return _this177.video.audioTracks.length > 1;
          } else {
            return _this177._hls.audioTracks.length > 1;
          }
        });
      }
    }, {
      ...
      value: function getAudioTracks() {
        ...
        return this._deferredAction(function () {
          if (paella.utils.userAgent.system.iOS) {
            var result = [];
            Array.from(_this178.video.audioTracks).forEach(function (t) {
              result.push({
                id: t.id,
                groupId: "",
                name: t.label,
            ...
            return _this178._hls.audioTracks;
          }
        });
      }
    }, {
      ...
      value: function setCurrentAudioTrack(trackId) {
        ...
        return this._deferredAction(function () {
          if (paella.utils.userAgent.system.iOS) {
            var found = false;
            Array.from(_this179.video.audioTracks).forEach(function (track) {
              if (track.id == trackId) {
                found = true;
                track.enabled = true;
              } else {
            ...
            if (_this179._hls.audioTracks.some(function (track) {
              return track.id == trackId;
            })) {
              _this179._hls.audioTrack = trackId;
              return true;
            } else {
              return false;
            }
      ...
      value: function getCurrentAudioTrack() {
        ...
        return this._deferredAction(function () {
          if (paella.utils.userAgent.system.iOS) {
            var result = null;
            Array.from(_this180.video.audioTracks).some(function (t) {
              if (t.enabled) {
                result = t;
                return true;
              }
            ...
            _this180._hls.audioTracks.some(function (t) {
              if (t.id == _this180._hls.audioTrack) {
                _result = t;
                return true;
              }
            });
      ...
      value: function getQualities() {
        ...
        if (paella.utils.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve) {
            if (!_this181._qualities || _this181._qualities.length == 0) {
              _This._qualities = [];
              ...
              if (_this181._qualities.length > 1) {
      ...
      value: function printQualityes() {
        ...
        return new Promise(function (resolve, reject) {
          _this182.getCurrentQuality().then(function (cq) {
            return _this182.getNextQuality();
          }).then(function (nq) {
            resolve();
          });
        });
      ...
      value: function getNextQuality() {
        ...
        return new Promise(function (resolve, reject) {
          var index = _this183.qualityIndex;
          resolve(_this183._qualities[index]);
        });
      }
    }, {
      key: "getCurrentQuality",
      value: function getCurrentQuality() {
        ...
        if (paella.utils.userAgent.system.iOS) // ||
          ...
          return new Promise(function (resolve, reject) {
            resolve(_this184._qualities[_this184.qualityIndex]);
          });
        }
      }
    }]);
  ...
  var HLSVideoFactory = /*#__PURE__*/function (_paella$VideoFactory3) {
    ...
    var _super80 = _createSuper(HLSVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$KeyPlugin) {
    ...
    var _super81 = _createSuper(DefaultKeyPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB) {
    ...
    var _super82 = _createSuper(LegalPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB2) {
    ...
    var _super83 = _createSuper(LiveStreamIndicator);
...
(function () {
  var MpegDashVideo = /*#__PURE__*/function (_paella$Html5Video2) {
    ...
    var _super84 = _createSuper(MpegDashVideo);
    ...
    function MpegDashVideo(id, stream, left, top, width, height) {
      ...
      _this185 = _super84.call(this, id, stream, left, top, width, height, 'mpd');
      _this185._posterFrame = null;
      _this185._player = null;
      return _this185;
    }
    ...
    _createClass(MpegDashVideo, [{
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve) {
          _this187._deferredAction(function () {
            if (!_this187._qualities) {
              _this187._qualities = [];

              _this187._player.getBitrateInfoListFor("video").sort(function (a, b) {
                return a.bitrate - b.bitrate;
              }).forEach(function (item, index, bitrates) {
                _this187._qualities.push(_this187._getQualityObject(item, index, bitrates));
              });

              _this187.autoQualityIndex = _this187._qualities.length;

              _this187._qualities.push({
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          var currentQuality = _this188._player.getQualityFor("video");

          if (index == _this188.autoQualityIndex) {
            _this188._player.setAutoSwitchQuality(true);

            resolve();
          } else if (index != currentQuality) {
            _this188._player.setAutoSwitchQuality(false);

            _this188._player.off(dashjs.MediaPlayer.events.METRIC_CHANGED);

            _this188._player.on(dashjs.MediaPlayer.events.METRIC_CHANGED, function (a, b) {
              if (a.type == "metricchanged") {
                if (currentQuality != _this188._player.getQualityFor("video")) {
                  currentQuality = _this188._player.getQualityFor("video");
                  resolve();
                }
              }
            });

            _this188._player.setQualityFor("video", index);
          } else {
            resolve();
          }
        });
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          if (_this189._player.getAutoSwitchQuality()) {
            // auto quality
            resolve({
              index: _this189.autoQualityIndex,
              res: {
                w: null,
                h: null
              },
            ...
            var index = _this189._player.getQualityFor("video");

            resolve(_this189._getQualityObject(_this189._qualities[index], index, _this189._player.getBitrateInfoListFor("video")));
          }
        });
      }
    }, {
  ...
  var MpegDashVideoFactory = /*#__PURE__*/function (_paella$VideoFactory4) {
    ...
    var _super85 = _createSuper(MpegDashVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin11) {
    ...
    var _super86 = _createSuper(MultipleQualitiesPlugin);
    ...
    _createClass(MultipleQualitiesPlugin, [{
      ...
      value: function setup() {
        ...
        paella.events.bind(paella.events.qualityChanged, function (event) {
          return _this191.setQualityLabel();
        });
      }
    }, {
      key: "getButtonType",
      ...
      value: function getMenuContent() {
        ...
        this._available.forEach(function (q, index) {
          ...
          if (resH >= _this192.config.minVisibleQuality || resH <= 0) {
            buttonItems.push({
              id: q.shortLabel(),
              title: q.shortLabel(),
              value: index,
              icon: "",
              className: _this192.getButtonItemClass(q.shortLabel()),
              "default": false
            });
          }
        });
      ...
      value: function menuItemSelected(itemData) {
        ...
        paella.player.videoContainer.setQuality(itemData.value).then(function () {
          paella.player.controls.hidePopUp(_this193.getName());

          _this193.setQualityLabel();
        });
      }
    }, {
      key: "setQualityLabel",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin12) {
    ...
    var _super87 = _createSuper(PIPModePlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin13) {
    ...
    var _super88 = _createSuper(PlayPauseButtonPlugin);
    ...
    function PlayPauseButtonPlugin() {
      ...
      _this195 = _super88.call(this);
      _this195.playIconClass = 'icon-play';
      _this195.replayIconClass = 'icon-loop2';
      _this195.pauseIconClass = 'icon-pause';
      _this195.playSubclass = 'playButton';
      _this195.pauseSubclass = 'pauseButton';
      return _this195;
    }
    ...
    _createClass(PlayPauseButtonPlugin, [{
      ...
      value: function setup() {
        ...
        paella.events.bind(paella.events.play, function (event) {
          _this196.changeIconClass(_this196.pauseIconClass);

          _this196.changeSubclass(_this196.pauseSubclass);

          _this196.setToolTip(paella.utils.dictionary.translate("Pause"));
        });
        paella.events.bind(paella.events.pause, function (event) {
          _this196.changeIconClass(_this196.playIconClass);

          _this196.changeSubclass(_this196.playSubclass);

          _this196.setToolTip(paella.utils.dictionary.translate("Play"));
        });
        paella.events.bind(paella.events.ended, function (event) {
          _this196.changeIconClass(_this196.replayIconClass);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl9) {
    ...
    var _super89 = _createSuper(PlayButtonOnScreen);
    ...
    function PlayButtonOnScreen() {
      ...
      _this197 = _super89.call(this);
      _this197.containerId = 'paella_plugin_PlayButtonOnScreen';
      _this197.container = null;
      _this197.enabled = true;
      _this197.isPlaying = false;
      _this197.showIcon = true;
      _this197.firstPlay = false;
      return _this197;
    }
    ...
    _createClass(PlayButtonOnScreen, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        paella.data.read('relatedVideos', {
          ...
          _this198.showOnEnd = !Array.isArray(data) || data.length == 0;
        });
        onSuccess(!paella.player.isLiveStream() || paella.utils.userAgent.system.Android || paella.utils.userAgent.system.iOS || !paella.player.videoContainer.supportAutoplay());
      }
    }, {
      key: "getIndex",
      value: function getIndex() {
      ...
      value: function setup() {
        ...
        $(this.container).click(function () {
          return _this199.onPlayButtonClick();
        });
      }
    }, {
      key: "getEvents",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin14) {
    ...
    var _super90 = _createSuper(PlaybackRate);
      ...
      value: function getMenuContent() {
        ...
        this.available_rates.forEach(function (rate) {
          ...
          buttonItems.push({
            ...
            value: rate,
            icon: "",
            className: _this200.getButtonItemClass(profileName),
            "default": rate == 1.0
          });
        });
        return buttonItems;
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin15) {
    ...
    var _super91 = _createSuper(RatePlugin);
    ...
    _createClass(RatePlugin, [{
      ...
      value: function vote(score) {
        ...
        paella.data.write('rate', {
          ...
          paella.data.read('rate', {
            ...
            if (data && _typeof(data) == 'object') {
              _this202.score = Number(data.mean).toFixed(1);
              _this202.count = data.count;
              _this202.myScore = data.myScore;
              _this202.canVote = data.canVote;
            }

            _this202.updateHeader();

            _this202.updateRateButtons();
          });
        });
      }
    }, {
      ...
      value: function updateVote() {
        ...
        this.buttons.forEach(function (item, index) {
          item.className = index < _this203.myScore ? "starButton glyphicon glyphicon-star" : "starButton glyphicon glyphicon-star-empty";
        });
      }
    }]);
...
paella.addDataDelegate("relatedVideos", function () {
  return /*#__PURE__*/function (_paella$DataDelegate2) {
    ...
    var _super92 = _createSuper(RelatedVideoDataDelegate);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl10) {
    ...
    var _super93 = _createSuper(RelatedVideoPlugin);
    ...
    _createClass(RelatedVideoPlugin, [{
      ...
      value: function checkEnabled(onSuccess) {
        ...
        paella.data.read('relatedVideos', {
          ...
          _this204._relatedVideos = data;
          onSuccess(Array.isArray(_this204._relatedVideos) && _this204._relatedVideos.length > 0);
        });
      }
    }, {
      key: "setup",
...
(function () {
  var RTMPVideo = /*#__PURE__*/function (_paella$VideoElementB5) {
    ...
    var _super94 = _createSuper(RTMPVideo);
    ...
    function RTMPVideo(id, stream, left, top, width, height) {
      ...
      _this205 = _super94.call(this, id, stream, 'div', left, top, width, height);
      _this205._posterFrame = null;
      _this205._currentQuality = null;
      _this205._duration = 0;
      _this205._paused = true;
      _this205._streamName = null;
      _this205._flashId = null;
      _this205._swfContainer = null;
      _this205._flashVideo = null;
      _this205._volume = 1;
      _this205._flashId = id + 'Movie';
      _this205._streamName = 'rtmp';

      var This = _assertThisInitialized(_this205);

      _this205._stream.sources.rtmp.sort(function (a, b) {
        return a.res.h - b.res.h;
      });
    ...
    _createClass(RTMPVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          if (_this206.ready) {
            ...
            $(_this206.swfContainer).bind('paella:flashvideoready', function () {
              _this206._ready = true;
              resolve(action());
            });
          }
        });
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          _this207._deferredAction(function () {
            var videoData = {
      ...
      value: function getQualities() {
        ...
        return new Promise(function (resolve, reject) {
          setTimeout(function () {
            ...
            sources.forEach(function (s) {
              index++;
              result.push(_this208._getQualityObject(index, s));
            });
            resolve(result);
          }, 50);
        });
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          var paused = _this209._paused;
          var sources = _this209._stream.sources.rtmp;
          _this209._currentQuality = index < sources.length ? index : 0;
          var source = sources[index];
          _this209._ready = false;
          _this209._isReady = false;

          _this209.load().then(function () {
            resolve();
          });
        });
      }
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          resolve(_this210._getQualityObject(_this210._currentQuality, _this210._stream.sources.rtmp[_this210._currentQuality]));
        });
      }
    }, {
      key: "play",
  ...
  var RTMPVideoFactory = /*#__PURE__*/function (_paella$VideoFactory5) {
    ...
    var _super95 = _createSuper(RTMPVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB3) {
    ...
    var _super99 = _createSuper(ShowEditorPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin18) {
    ...
    var _super100 = _createSuper(ThemeChooserPlugin);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$PlaybackCanva2) {
    ...
    var _super101 = _createSuper(TimeMarksPlaybackCanvasPlugin);
        ...
        if (this._hasSlides) {
          this._frameKeys.forEach(function (l) {
            ...
            if (timeInstant > 0 && timeInstant < videoData.trimming.duration) {
              ...
              _this211.drawTimeMark(context, left, height);
            }
          });
        }
      }
...
paella.addDataDelegate("cameraTrack", function () {
  return /*#__PURE__*/function (_paella$DataDelegate3) {
    ...
    var _super102 = _createSuper(TrackCameraDataDelegate);
...
(function () {
  ...
  paella.addPlugin(function () {
    return /*#__PURE__*/function (_paella$EventDrivenPl11) {
      ...
      var _super103 = _createSuper(Track4KPlugin);
      ...
      function Track4KPlugin() {
        ...
        _this212 = _super103.call(this);
        g_track4kPlugin = _assertThisInitialized(_this212);
        _this212._videoData = {};
        _this212._trackData = [];
      ...
      _createClass(Track4KPlugin, [{
        ...
        value: function checkEnabled(cb) {
          ...
          paella.data.read('cameraTrack', {
            ...
            if (data) {
              _this213._videoData.width = data.width;
              _this213._videoData.height = data.height;
              _this213._videoData.originalWidth = data.originalWidth;
              _this213._videoData.originalHeight = data.originalHeight;
              _this213._trackData = data.positions;
              _this213._enabled = true;
            } else {
              _this213._enabled = false;
            }

            cb(_this213._enabled);
          });
        }
      }, {
        key: "getName",
  ...
  paella.addPlugin(function () {
    return /*#__PURE__*/function (_paella$ButtonPlugin19) {
      ...
      var _super104 = _createSuper(VideoZoomTrack4KPlugin);
      ...
      _createClass(VideoZoomTrack4KPlugin, [{
        ...
        value: function buildContent(domElement) {
          ...
          domElement.appendChild(getZoomButton('zoom-auto', function (evt) {
            ...
            paella.player.controls.hidePopUp(_this214.getName());
          }, "auto"));
        }
      }, {
        key: "zoomIn",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$2) {
    ...
    var _super105 = _createSuper(ElasticsearchSaverPlugin);
    ...
    _createClass(ElasticsearchSaverPlugin, [{
      ...
      value: function log(event, params) {
        ...
        paella.player.videoContainer.currentTime().then(function (t) {
          ...
          paella.ajax.post({
            url: _this215._url + "/" + _this215._index + "/" + _this215._type + "/",
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$3) {
    ...
    var _super106 = _createSuper(GoogleAnalyticsTracking);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$4) {
    ...
    var _super107 = _createSuper(PiwikAnalyticsTracking);
...
(function () {
  paella.addCanvasPlugin("video360", true, true, function () {
    return /*#__PURE__*/function (_paella$WebGLCanvas) {
      ...
      var _super108 = _createSuper(Video360Canvas);
...
(function () {
  ...
  paella.addCanvasPlugin("video360Theta", true, true, function () {
    return /*#__PURE__*/function (_paella$WebGLCanvas2) {
      ...
      var _super109 = _createSuper(Video360ThetaCanvas);
...
paella.addDataDelegate('metadata', function () {
  return /*#__PURE__*/function (_paella$DataDelegate4) {
    ...
    var _super110 = _createSuper(VideoManifestMetadataDataDelegate);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$VideoOverlayB4) {
    ...
    var _super111 = _createSuper(VideoDataPlugin);
...
paella.addPlugin(function () {
  ...
  return /*#__PURE__*/function (_paella$VideoOverlayB5) {
    ...
    var _super112 = _createSuper(VideoZoomPlugin);
    ...
    _createClass(VideoZoomPlugin, [{
      ...
      value: function setup() {
        ...
        players.forEach(function (player, index) {
          if (player.allowZoom()) {
            _this218._available = player.zoomAvailable();
            _this218._visible = _this218._available;
            setupButtons.apply(_this218, [player]);
            player.supportsCaptureFrame().then(function (supports) {
              if (supports) {
                var thumbContainer = document.createElement('div');
                thumbContainer.className = "zoom-container";
                var thumb = getThumbnailContainer.apply(_this218, [index]);
                var zoomRect = getZoomRect.apply(_this218);

                _this218.button.appendChild(thumbContainer);

                thumbContainer.appendChild(thumb);
                thumbContainer.appendChild(zoomRect);
                $(thumbContainer).hide();

                _this218._thumbnails.push({
                  player: player,
                ...
                checkVisibility.apply(_this218);
              }
            });
          }
        });
        ...
        paella.events.bind(paella.events.play, function (evt) {
          var updateThumbs = function updateThumbs() {
            _this218._thumbnails.forEach(function (item) {
        ...
        paella.events.bind(paella.events.videoZoomChanged, function (evt, target) {
          _this218._thumbnails.some(function (thumb) {
        ...
        paella.events.bind(paella.events.zoomAvailabilityChanged, function (evt, target) {
          _this218._available = target.available;
          _this218._visible = target.available;
          checkVisibility.apply(_this218);
        });
        paella.events.bind(paella.events.controlBarDidHide, function () {
          _this218._visible = false;
          checkVisibility.apply(_this218);
        });
        paella.events.bind(paella.events.controlBarDidShow, function () {
          _this218._visible = true;
          checkVisibility.apply(_this218);
        });
      }
    }, {
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin20) {
    ...
    var _super113 = _createSuper(VideoZoomToolbarPlugin);
    ...
    _createClass(VideoZoomToolbarPlugin, [{
      ...
      value: function buildContent(domElement) {
        ...
        paella.events.bind(paella.events.videoZoomChanged, function (evt, target) {
          _this219.setText(Math.round(target.video.zoom) + "%");
        });
        this.setText("100%");
        ...
        domElement.appendChild(getZoomButton('zoom-in', function (evt) {
          _this219.targetPlayer.zoomIn();
        }));
        domElement.appendChild(getZoomButton('zoom-out', function (evt) {
          _this219.targetPlayer.zoomOut();
        }));
      }
    }]);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin21) {
    ...
    var _super114 = _createSuper(ViewModePlugin);
    ...
    _createClass(ViewModePlugin, [{
      ...
      value: function getMenuContent() {
        ...
        paella.profiles.profileList.forEach(function (profileData, index) {
          ...
          if (_this220.active_profiles) {
            var active = false;

            _this220.active_profiles.some(function (ap) {
              if (ap == profile) {
                active = ap;
                return true;
              }
          ...
          var url = _this220.getButtonItemIcon(profileData);
          ...
          buttonItems.push({
            ...
            icon: url,
            className: _this220.getButtonItemClass(profileData.id),
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$ButtonPlugin22) {
    ...
    var _super115 = _createSuper(VolumeRangePlugin);
    ...
    _createClass(VolumeRangePlugin, [{
      ...
      value: function getExpandableContent() {
        ...
        var updateMasterVolume = function updateMasterVolume() {
          ...
          var slaveVolume = 0;
          _this221._control_NotMyselfEvent = false;
      ...
      value: function updateClass() {
        ...
        paella.player.videoContainer.volume().then(function (volume) {
          ...
          _this222.changeIconClass(selected);
        });
      }
    }]);
...
(function () {
  var WebmVideoFactory = /*#__PURE__*/function (_paella$VideoFactory6) {
    ...
    var _super116 = _createSuper(WebmVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$EventDrivenPl12) {
    ...
    var _super117 = _createSuper(WindowTitlePlugin);
...
(function () {
  var YoutubeVideo = /*#__PURE__*/function (_paella$VideoElementB6) {
    ...
    var _super118 = _createSuper(YoutubeVideo);
    ...
    function YoutubeVideo(id, stream, left, top, width, height) {
      ...
      _this224 = _super118.call(this, id, stream, 'div', left, top, width, height);
      _this224._posterFrame = null;
      _this224._currentQuality = null;
      _this224._autoplay = false;
      _this224._readyPromise = null;
      _this224._readyPromise = $.Deferred();
      return _this224;
    }
    ...
    _createClass(YoutubeVideo, [{
      ...
      value: function _deferredAction(action) {
        ...
        return new Promise(function (resolve, reject) {
          _this225._readyPromise.then(function () {
            resolve(action());
          }, function () {
            reject();
          });
      ...
      value: function getVideoData() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          _this226._deferredAction(function () {
            var videoData = {
      ...
      value: function setQuality(index) {
        ...
        return new Promise(function (resolve, reject) {
          _this228._qualityListReadyPromise.then(function (q) {
            for (var key in _this228._qualities) {
              var searchQ = _this228._qualities[key];

              if (_typeof(searchQ) == "object" && searchQ.index == index) {
                _this228.video.setPlaybackQuality(searchQ.label);
      ...
      value: function getCurrentQuality() {
        ...
        return new Promise(function (resolve, reject) {
          _this229._qualityListReadyPromise.then(function (q) {
            resolve(_this229._qualities[_this229.video.getPlaybackQuality()]);
          });
        });
      }
    }, {
      ...
      value: function play() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          new paella.utils.Timer(function (timer) {
            var q = _this230.video.getAvailableQualityLevels();

            if (q.length) {
              timer.repeat = false;

              _this230._qualityListReadyPromise.resolve(q);
      ...
      value: function pause() {
        ...
        return this._deferredAction(function () {
          _this231._playing = false;

          _this231.video.pauseVideo();
        });
      }
    }, {
      key: "isPaused",
      ...
      value: function duration() {
        ...
        return this._deferredAction(function () {
          return _this233.video.getDuration();
        });
      }
    }, {
      key: "setCurrentTime",
      ...
      value: function currentTime() {
        ...
        return this._deferredAction(function () {
          return _this235.video.getCurrentTime();
        });
      }
    }, {
      key: "setVolume",
      value: function setVolume(volume) {
        ...
        return this._deferredAction(function () {
          _this236.video.setVolume && _this236.video.setVolume(volume * 100);
        });
      }
    }, {
      key: "volume",
      value: function volume() {
        ...
        return this._deferredAction(function () {
          return _this237.video.getVolume() / 100;
        });
      }
    }, {
      key: "setPlaybackRate",
      value: function setPlaybackRate(rate) {
        ...
        return this._deferredAction(function () {
          _this238.video.playbackRate = rate;
        });
      }
    }, {
      key: "playbackRate",
      value: function playbackRate() {
        ...
        return this._deferredAction(function () {
          return _this239.video.playbackRate;
        });
      }
    }, {
      key: "goFullScreen",
      ...
      value: function unFreeze() {
        ...
        return this._deferredAction(function () {
          var c = document.getElementById(_this241.video.className + "canvas");
          $(c).remove();
        });
      }
    }, {
      ...
      value: function freeze() {
        ...
        return this._deferredAction(function () {
          var canvas = document.createElement("canvas");
          canvas.id = _this242.video.className + "canvas";
          canvas.width = _this242.video.videoWidth;
          canvas.height = _this242.video.videoHeight;
          canvas.style.cssText = _this242.video.style.cssText;
          canvas.style.zIndex = 2;
          var ctx = canvas.getContext("2d");
          ctx.drawImage(_this242.video, 0, 0, Math.ceil(canvas.width / 16) * 16, Math.ceil(canvas.height / 16) * 16); //Draw image

          _this242.video.parentElement.appendChild(canvas);
        });
      }
    }, {
      key: "unload",
  ...
  var YoutubeVideoFactory = /*#__PURE__*/function (_paella$VideoFactory7) {
    ...
    var _super119 = _createSuper(YoutubeVideoFactory);
...
paella.addPlugin(function () {
  return /*#__PURE__*/function (_paella$userTracking$5) {
    ...
    var _super120 = _createSuper(MatomoTracking);
...
paella.addPlugin(function () {
  ...
  return /*#__PURE__*/function (_paella$userTracking$6) {
    ...
    var _super121 = _createSuper(X5gonTracking);
