---
title: "Life cycle"
description: "The Paella player life cycle is the sequence of events that occur from the moment the player is created until it is destroyed. This document describes the life cycle of the player and its components, including the player instance, plugins, and events."
---
...
![Player states](life_cycle/paella-player-states.svg)
...
It is important to note that when the player is downloaded, the registered event handlers will be deleted if we do not indicate otherwise. See all the information about [event handlers in this document](/reference/events).
