...
description: "This document describes the ManifestParser API, which allows us to extract information from a video manifest."
---
...
- **`player.chapters`**: returns the `chapters` section of the video manifest.
- **`player.captions`** (paella-core >= 2.4.0): returns the `captions` section of the video manifest.
