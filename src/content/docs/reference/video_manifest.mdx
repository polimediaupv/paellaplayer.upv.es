...
**timeline:** (paella-core >= 1.5) Contains the information to display the timeline image. It is an object with the following attributes:

  - **url:** The URL of the timeline image.
  - **rows:** The number of rows in the timeline.
  - **cols:** The number of columns in the timeline.

You can get more information about the timeline in the [timeline image documentation](/reference/timeline_settings).
...
Allows to define the soft trimming configuration of the video. For more information, see the [videoContainer](/reference/video_container) documentation. All the attributes are required:
...
As of `paella-core` version 1.46, we can use the `manifestParser` API to extract data from the video manifest. See more information about this in the [`ManifestParser` page](/reference/manifest_parser)
