...
It is a special type of [PopUpButtonPlugin](/reference/pop_up_button_plugins) that implements a menu. The menu options are specified by overriding the `async getMenu()` method.
