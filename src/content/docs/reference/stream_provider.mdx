...
The multiple audio control functions allow you to change the audio track of the main audio stream, provided that the [video plug-in](/reference/video_plugins) supports it. All multi audio functions work with instances of objects of the `AudioTrackData` class. More information on videos with multiple audio tracks can be found in [this document](/reference/multiaudio).
