...
description: "This document describes how to integrate the Web Audio API with Paella Player through the Stream Provider"
---
...
- [Audio Processor plugins](/plugins/audio_processor_plugins)