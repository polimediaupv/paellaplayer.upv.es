---
title: Loader
description: "You can create a custom loader for your player implementing a custom Loader class"
---

The default paella player loader [can be customized using the `initParams` object](/reference/initialization).
