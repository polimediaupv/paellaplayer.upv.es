---
title: HLS multi audio with Wowza
description: This document describes how to use Wowza and SMIL files to generate an HLS with multiple audio tracks.
---
...
If you don't want to use Wowza, you can encode to HLS directly with ffmpeg. Please read [Using ffmpeg to generate an HLS with multiple audio tracks](/guides/ffmpeg_multiple_audio_tracks).
