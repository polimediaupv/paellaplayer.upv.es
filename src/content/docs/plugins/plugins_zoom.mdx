---
title: "Zoom plugins"
description: "This document describes the @asicupv/paella-zoom-plugins package."
---
## Usage
...
Zooming works with the mouse scroll wheel by holding down the `alt` key. 
...
### es.upv.paella.zoomInButtonPlugin and es.upv.paella.zoomOutButtonPlugin
...
### es.upv.paella.canvasZoomInButtonPlugin and es.upv.paella.canvasZoomOutButtonPlugin
