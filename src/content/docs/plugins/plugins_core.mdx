...
## [Data plugins](/plugins/data_plugins)
...
## [Layout plugins](/plugins/video_layout)
...
At this point, you should check the [documentation on video layouts](/plugins/video_layout), but in short, each applicable layout is identified through a valid unique content identifier. This information is defined in the plugin configuration:
...
## [Video format plugins](/plugins/video_plugins)

Plugins to implement support for new video formats. Check the documentation about [video format plugins in this document](/plugins/video_plugins).

### es.upv.paella.imageVideoFormat.js

Support for virtual video composed by a list of images. You can check the documentation about this special video type in [this document](/plugins/video_plugin_images).

### es.upv.paella.mp4VideoFormat.js

Support for progressive download video. Check the documentation about this format [here](/plugins/video_plugin_mp4).

### es.upv.paella.HtmlVideoFormat.js

Support for multiformat progressive download video. Check the documentation about this format [here](/plugins/video_plugin_html).

### es.upv.paella.audioVideoFormat.js

Support for audio-only streams. To use this plugin it's important to enable the `es.upv.paella.audioCanvas` plugin. You can get more information about audio-only format in [this document](/plugins/video_plugin_audio).

## [Canvas plugins](/plugins/canvas_plugins)

### es.upv.paella.videoCanvas.js

Canvas to display HTML-compliant video formats, i.e. those that use the `<video>` element to display multimedia content. [video canvas plugin documentation](/plugins/video_canvas_plugin).

### es.upv.paella.audioCanvas.js

Canvas to display audio-only streams. This canvas fills the space of the video with an image. The source of the image will depend on the video format used. [audio canvas plugin documentation](/plugins/audio_canvas_plugin).
