---
title: "Audio Processor Plugins"
description: "This document describes how to create and use audio processor plugins in Paella Player."
---
...
- [Web Audio API integration in Paella Player](/reference/web_audio_api_integration)