...
The MP4 Multi Quality Video plugin extends the default implementation of the MP4 Video Plugin in `@asicupv/paella-core` package, so the rest of the configuration parameters and behavior are the same as the MP4 Video Plugin. For more information about the configuration parameters, see the [MP4 Video Plugin documentation](/plugins/video_plugin_mp4).